[Google Analytics](https://analytics.google.com/)은 웹 사이트의 트래픽을 추적하는 서비스로, 이 페이지에서는 [[Obsidian Publish 소개|Obsidian Publish]] 사이트에서 Google Analytics를 활성화하는 방법을 설명합니다.
