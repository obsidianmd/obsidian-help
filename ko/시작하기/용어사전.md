...
**첨부 파일**은 보관소 외부에서 생성되고 나중에 추가된 [[허용되는 파일 형식|허용되는 파일 형식]]입니다.

## command

**명령**은 [[명령어 팔레트|명령어 팔레트]]에서 선택하거나 [[#hotkey|단축키]]로 할 수 있는 작업입니다.
...
**단축키**는 [[#command]]에 대한 키보드 단축키입니다. [[유저 인터페이스/단축키]]와 [[유저 인터페이스/단축키|How to/Use hotkeys]]도 참고하십시오.
...
- [[커뮤니티 플러그인]]은 써드파티 플러그인 개발자가 작성하며 사용하기 전에 [[커뮤니티 플러그인#Install a community plugin|installed]]해야 합니다.
...
**스니펫** 또는 [[CSS 스니펫|CSS snippet]]은 Obsidian의 모양을 변경하며 [[#theme]]와 유사합니다. 테마와 달리 여러 스니펫을 동시에 적용할 수 있습니다.
