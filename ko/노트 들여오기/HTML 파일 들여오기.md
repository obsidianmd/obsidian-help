...
aliases:
  - HTML 파일에서 노트 가져오기
---
Obsidian을 사용하면 공식 [[Importer|Importer 플러그인]]을 사용하여 개별 HTML 파일 및 전체 폴더의 HTML 파일을 쉽게 가져올 수 있습니다. 이 기능은 웹 사이트 전체를 [[Obsidian 스타일 Markdown|Markdown]] 형식으로 저장하거나 HTML로 내보내는 도구에서 데이터를 가져오려는 경우 유용합니다.
