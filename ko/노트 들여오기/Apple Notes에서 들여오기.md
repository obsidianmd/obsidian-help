...
Apple은 노트를 내보내는 기본 옵션을 제공하지 않습니다. 그러나 Chintan Ghate의 [Exporter](https://apps.apple.com/us/app/exporter/id1099120373)와 같은 서드파티 도구가 있습니다. 대부분의 도구는 Apple Notes에서 내보낼 수 있는 데이터에 제한이 있으며 호환성 있는 출력 데이터를 제공하지 못할 수 있습니다. 이러한 도구는 Apple Notes가 주로 텍스트로만 구성되어 있고 첨부 파일이나 그림, 스캔 등 특수 기능이 적을 때 가장 잘 작동합니다.
