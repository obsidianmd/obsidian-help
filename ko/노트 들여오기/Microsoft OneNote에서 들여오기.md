...
cssclasses:
  - soft-embed
---
Obsidian을 사용하면 Microsoft OneNote에서 노트를 쉽게 마이그레이션할 수 있어요. 이를 위해서 [[들여오기|Importer 플러그인]]을 사용해요. OneNote 데이터를 Obsidian 및 다른 많은 앱에서 사용할 수 있는 내구성 있는 마크다운 파일로 변환해요.
...
10. **Import**를 선택하여 생성된 템플릿을 검토하고 페이지의 미리보기 예시를 확인해요.
11. **Import**를 다시 선택하고 가져오기가 완료될 때까지 기다려요.
...
9. **Import**를 선택하여 생성된 템플릿을 검토하고 페이지의 미리보기 예시를 확인해요.
10. **Import**를 다시 선택하고 가져오기가 완료될 때까지 기다려요.
...
[[임포터 템플릿|Importer 템플릿]]을 사용하여 OneNote 데이터를 가져오는 방식을 완전히 구성할 수 있어요.
