...
두 가지 들여오기 방법 모두 들여오기 시작 전에 미리보기를 보여줘요. 생성된 템플릿을 편집하거나 보관함에서 Markdown 템플릿을 선택할 수 있어요. 커버 및 데이터베이스 속성 이름 등의 설정은 미리보기에 표시되는 생성된 속성을 업데이트해요. [[Importer 템플릿]]을 참고하세요.
...
[[Importer 템플릿|Importer 템플릿]]을 사용하여 Notion 데이터가 들여와지는 방식을 완전히 설정할 수 있어요.
