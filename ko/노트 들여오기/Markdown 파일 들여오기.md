...
### 다른 Markdown 형식에서 변환하기

Obsidian은 [[Obsidian 스타일 Markdown|Obsidian 마크다운]]을 사용합니다. 일부 앱은 약간 다른 Markdown 구문을 사용할 수 있습니다. 파일을 Obsidian의 Markdown 구문으로 변환하려면 [[마크다운 형식 불러오기|형식 변환기]]를 사용할 수 있습니다.
