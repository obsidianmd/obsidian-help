...
> [!tip]- 플러그인 사용하기
> 커뮤니티 플러그인 [Android Nomedia](https://obsidian.md/plugins?id=android-nomedia)를 사용하면 더 쉽게 할 수 있어요. Android 휴대폰에 설치하세요. `.nomedia` 파일은 Obsidian Sync를 통해 기기 간에 동기화되지 않아요.
