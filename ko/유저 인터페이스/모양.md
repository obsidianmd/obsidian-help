...
You can change the appearance of Obsidian by using [[테마|custom themes]]. Browse hundreds of community-made themes by going to **Settings → Appearance**, then click **Manage** to view and install themes.

You can also tweak themes using [[CSS 스니펫]] and [build your own theme](https://docs.obsidian.md/Themes/App+themes/Build+a+theme) .
