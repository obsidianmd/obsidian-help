...
Αναβαθμίστε στην τελευταία [[Ενημέρωση Obsidian|έκδοση προγράμματος εγκατάστασης Obsidian]] (1.12.7+).
...
Εμφάνιση δέντρου χώρου εργασίας.

```bash
ids                # συμπερίληψη αναγνωριστικών στοιχείων χώρου ε
