...
> Multiple adjacent blank spaces in and between paragraphs collapse to a single space when displaying a note in [[ویرایش و پیش‌نمایشِ مارک‌داون#Editor views|Reading view]] and on [[مقدمه ای بر ابسیدین پابلیش|Obsidian Publish]] sites.
> 
> ```md
