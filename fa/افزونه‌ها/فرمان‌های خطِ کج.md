...
> [!TIP] Fuzzy matching
> Like the [[فرمان‌دان]], Slash commands supports fuzzy matching which lets you search commands even if you don't know their exact names. For example, type "scf" to find the **Save current file** command.
