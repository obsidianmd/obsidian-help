...
- In the [[مرورگرِ پرونده‌ها]], right-click the folder you want to create the canvas in.
- Select **New canvas**.
...
> [!note]
> Text-only cards don't appear in [[پشت‌وندها]]. To make them appear, you need to convert them to a file.

### افزودنِ کارت از یادداشت‌ها
...
Or, you can add them to the canvas by dragging the file from the [[مرورگرِ پرونده‌ها]].
...
### گروه‌بندیِ کارت‌های انتخاب‌شده
