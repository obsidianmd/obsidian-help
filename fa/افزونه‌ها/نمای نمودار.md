...
To open the Graph view, click **Open graph view** in the [[نوار]].
...
- **Search files** lets you filter notes based on a search query. To learn about how you can write more advanced search queries, refer to [[جست‌وجو]].
...
To learn about how you can write more advanced search queries, refer to [[جست‌وجو]].
