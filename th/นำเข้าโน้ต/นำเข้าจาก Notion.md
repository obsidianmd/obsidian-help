...
6. ภายใต้ **API token** คลิก **ลิงก์...** เพื่อเพิ่มความลับใหม่ สำหรับ **ID** ให้ตั้งชื่อเช่น `notion` และสำหรับ **ความลับ** ให้วาง **Internal Integration Secret** ของคุณจาก Notion
