...
1. **บัญชี Notion (แนะนำ)** เชื่อมต่อโดยตรงกับพื้นที่ทำงานของคุณและช่วยให้คุณรักษา Databases และสูตรซึ่งจะถูกแปลงเป็น [[แนะนำฐาน|ฐาน]] ต้องใช้โทเค็นการผสาน Notion และการเชื่อมต่ออินเทอร์เน็ต
2. **นำเข้าผ่านไฟล์** ใช้ไฟล์ส่งออก `.zip` ของ Notion ไม่รักษา Databases แต่ไม่ต้องใช้โทเค็น API หรือการเชื่อมต่ออินเทอร์เน็ต

## นำเข้าจากบัญชี Notion ของคุณ

### สร้างโทเค็นการเข้าถึง API ของ Notion

ในการเข้าถึงข้อมูล Notion ของคุณผ่าน API คุณต้องมีโทเค็นการเข้าถึง ขั้นตอนนี้ใช้เวลาประมาณสองนาที

โทเค็นเป็นสตริงยาวของตัวเลขและตัวอักษร โดยทั่วไปจะเริ่มต้นด้วย `ntn_...` ที่จะช่วยให้คุณดาวน์โหลดข้อมูลจาก Notion ได้

1. เข้าสู่ระบบแดชบอร์ด [Notion Connections](https://app.notion.com/developers/connections) ของคุณ
2. เลือก **New connection**
	1. ตั้งชื่อการเชื่อมต่อของคุณ เช่น "Personal" สามารถใช้ชื่อใดก็ได้
	2. เลือก **Access token** เป็นวิธีการยืนยันตัวตน
	3. เลือกพื้นที่ทำงานที่คุณต้องการส่งออกเป็น **Installable in**

![[notion-integration.png#interface]]

3. คลิก **Create connection**
4. ในแท็บ **Configuration** โทเค็น API ของคุณสามารถเข้าถึงได้ในฟิลด์ **Access token**
5. เลือก **Show** จากนั้น **Copy**
6. บันทึกโทเค็นไว้ในที่ปลอดภัย เช่น ตัวจัดการรหัสผ่านของคุณ

![[notion-token.png#interface]]

ถัดไป ให้สิทธิ์การเชื่อมต่อของคุณเข้าถึงหน้าและฐานข้อมูล Notion ที่คุณต้องการนำเข้า

1. ไปที่แท็บ **Content access** ของการเชื่อมต่อที่คุณเพิ่งสร้าง
2. เพิ่มหน้าและฐานข้อมูลที่คุณต้องการนำเข้า
...
6. ภายใต้ **API token** คลิก **ลิงก์...** เพื่อเพิ่มความลับใหม่ สำหรับ **ID** ให้ตั้งชื่อเช่น `notion` และสำหรับ **ความลับ** ให้วาง **Access token** ของคุณจาก Notion
...
1. ไปที่ **Settings** ที่ด้านบนของแถบด้านข้าง Notion
