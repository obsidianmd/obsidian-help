...
cssclasses:
  - soft-embed
---
Obsidian מאפשר לך להעביר בקלות את הנתונים שלך מ-Notion באמצעות [[ייבוא|תוסף הייבוא]]. פעולה זו תמיר את מרחב העבודה שלך ב-Notion לקבצי Markdown עמידים שתוכל להשתמש בהם ללא חיבור לאינטרנט עם Obsidian ואפליקציות רבות אחרות.

Obsidian מציע שתי דרכים לייבא את נתוני ה-Notion שלך:

1. **חשבון Notion (מומלץ)** מתחבר ישירות למרחב העבודה שלך ומאפשר לשמר Databases ונוסחאות שמומרים ל-[[מבוא ל-Bases|Bases]]. דורש טוקן אינטגרציה של Notion וחיבור לאינטרנט.
2. **ייבוא קבצים** משתמש בקבצי ייצוא `.zip` של Notion. אינו שומר על Databases אך אינו דורש טוקן API או חיבור לאינטרנט.

## התאמה אישית של דפים מיובאים

שתי שיטות הייבוא מציגות תצוגה מקדימה לפני שהייבוא מתחיל. ניתן לערוך את התבנית שנוצרה או לבחור תבנית Markdown מהכספת שלך. הגדרות כגון תמונת הכיסוי ושמות מאפייני ה-database מעדכנות את המאפיינים שנוצרו המוצגים בתצוגה המקדימה. ראה [[תבניות Importer]].

## ייבוא מחשבון ה-Notion שלך
...
9. בחר **Import** כדי לסקור את התבנית שנוצרה ולצפות בתצוגה מקדימה של דוגמאות מהדפים שלך.
10. בחר **Import** שוב והמתן עד שהייבוא יסתיים.
...
השתמש ב-[[תבניות Importer|תבניות Importer]] כדי להגדיר באופן מלא כיצד נתוני ה-Notion שלך מיובאים.

![[תבניות Importer#משתנים]]
