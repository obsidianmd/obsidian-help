...
שתי שיטות הייבוא מציגות תצוגה מקדימה לפני שהייבוא מתחיל. ניתן לערוך את התבנית שנוצרה או לבחור תבנית Markdown מהכספת שלך. הגדרות כגון תמונת הכיסוי ושמות מאפייני ה-database מעדכנות את המאפיינים שנוצרו המוצגים בתצוגה המקדימה. ראה [[תבניות ייבוא|תבניות Importer]].
...
השתמש ב-[[תבניות ייבוא|תבניות Importer]] כדי להגדיר באופן מלא כיצד נתוני ה-Notion שלך מיובאים.
