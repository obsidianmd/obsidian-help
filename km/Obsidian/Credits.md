ឈ្មោះមិនបានរាយតាមចំនួនដែកបានជួយទេ, តែតាមលំដាប់អក្សរ(ប៉ុន្តែពួកយើងបានព្យាយាមហើយ!) ។
...
Credits ទៅអ្នកបង្កើត plugin សម្រាប់ pioneering functionality ដែលបានបញ្ចូលទៅក្នុង Obsidian:

- pjeby សម្រាប់ Hotkey Helper plugin
- javalent សម្រាប់ Admonition plugin
- NothingIsLost សម្រាប់ CodeMirror improvements ចំនួន ៦
- mgmeyers សម្រាប់ Indentation Guides plugin

## Builds

- jstone សម្រាប់ maintaining builds របស់យើងនៅលើ flathub
- adamgibbins និង ran-dall សម្រាប់ maintaining builds របស់យើងលើ homebrew
...
បើសិនជាអ្នកជាអ្នកបកប្រែ, សូមបង្កើត pull request ដើម្បីដាក់ "ឈ្មោះ(ភាសារបស់អ្នក)" ទៅផ្នែកខាងលើ ។ សូមរៀបបញ្ជីឈ្មោះឲ្យតាម់លំដាប់អក្សរ, សូមអរគុណ!

បើឈ្មោះរបស់អ្នកគ្មាននៅក្នុងអង់គ្លេស ហើយមិនអាចដាក់បង្ហាញជាលំដាប់អក្សរបាន, សូមប្រើទម្រង់នេះ: `your-github-username, [ឈ្មោះរបស់អ្នក] (ឈ្មោះភាសា)` ។

## Third party acknowledgements

Obsidian logo ដកលំនាំចេញពី:

[Crystal shard icon](https://icon-icons.com/icon/Crystal-Shard/88819)
ដោយ [Chanut is Industries](https://icon-icons.com/users/W52nHhY3W1VlvwyJTwS4d/icon-sets/ "Designer")
License: Attribution 3.0 Unported (CC BY 3.0)

Obsidian ប្រើ open source libraries នៅខាងក្រោម (តាមលំដាក់អក្សរ):
