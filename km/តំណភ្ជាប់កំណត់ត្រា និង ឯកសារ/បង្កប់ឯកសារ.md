...
To embed a file in your vault, add an exclamation mark (`!`) in front of an [[តំណភ្ជាប់ផ្ទៃក្នុង|Internal link]]. You can embed files in any of the [[ទម្រង់ឯកសារដែលទទួលយក]].
...
You can also embed links to [[តំណភ្ជាប់ផ្ទៃក្នុង#Link to a heading in a note|headings]] and [[តំណភ្ជាប់ផ្ទៃក្នុង#Link to a block in a note|blocks]].
...
To embed a list from a different note, first add a [[តំណភ្ជាប់ផ្ទៃក្នុង#Link to a block in a note|block identifier]] to your list:
...
![[ស្វែងរក#Embed search results in a note]]
