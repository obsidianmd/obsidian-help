...
If you're only trying to change how a link looks in one place, see how to [[តំណភ្ជាប់ផ្ទៃក្នុង#Change the link display text|Change the link display text]] instead.

![[តំណភ្ជាប់ផ្ទៃក្នុង#^callout-internal-links-link-text]]

## Add an alias to a note

To add an alias for a note, add `aliases` property in the note [[លក្ខណៈសម្បត្តិ]]. Aliases should always be formatted as a list in YAML.
...
1. Start typing the alias in an [[តំណភ្ជាប់ផ្ទៃក្នុង|internal link]]. Any alias shows up in the list of suggestions, with a curved arrow icon next to it.
...
By using [[តំណភ្ជាប់ខាងក្រោយ]], you can find unlinked mentions of aliases.

For example, after setting "AI" as an alias for "Artificial intelligence", you can see mentions of "AI" in other notes.

If you link an unlinked mention to an alias, Obsidian turns the mention into an [[តំណភ្ជាប់ផ្ទៃក្នុង|internal link]] with the alias as its display text.
