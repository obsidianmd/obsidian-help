...
Obsidian mobile apps are available for [[Obsidian សម្រាប់ iOS និង iPadOS|iOS and iPadOS]] and [[Obsidian សម្រាប់ Android|Android]]. You can download them from the [Apple App Store](https://apps.apple.com/us/app/obsidian-connected-notes/id1557175442) and [Google Play](https://play.google.com/store/apps/details?id=md.obsidian).
...
- [[Obsidian សម្រាប់ iOS និង iPadOS|iOS and iPadOS]]
...
1. Find **Manage toolbar options** under **[[ការកំណត់]]** → **Mobile**.
...
Quick Action defaults to open [[ក្ដារលាយពាក្យបញ្ជា]].
...
The middle plus in circle icon lets you create a new note or switch to an existing note. This is equivalent to opening [[ឧបករណ៍ផ្លាស់ប្តូររហ័ស]].
...
The mobile app has no [[រីបិន]]. Instead, the ribbon actions will be available when you tap **Open menu** ![[lucide-menu.svg#icon]], the last option on the navigation bar.

### Sidebars

For detailed information about how sidebars work on mobile, see [[របារចំហៀង#Open hidden sidebars#Mobile and smaller tablets|Opening sidebars on mobile]].
