...
permalink: symlinks
---
You can use [symbolic links](https://en.wikipedia.org/wiki/Symbolic_link) (symlinks) and [junctions](https://learn.microsoft.com/en-us/windows/win32/fileio/hard-links-and-junctions#junctions) in your vault to store files outside the vault and [[របៀបដែល Obsidian រក្សាទុកទិន្នន័យ#Global settings|system folder]].
