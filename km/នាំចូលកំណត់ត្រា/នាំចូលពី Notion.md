...
1. **គណនី Notion (ណែនាំ)** ភ្ជាប់ដោយផ្ទាល់ទៅកាន់ workspace របស់អ្នក ហើយអនុញ្ញាតឱ្យអ្នករក្សាទុក Databases និងរូបមន្តដែលត្រូវបានបម្លែងទៅជា [[ការណែនាំអំពី Bases|Bases]]។ តម្រូវឱ្យមាន Notion integration token និងការតភ្ជាប់អ៊ីនធឺណិត។
2. **ការនាំចូលតាមឯកសារ** ប្រើឯកសារ `.zip` នាំចេញពី Notion។ មិនរក្សាទុក Databases ប៉ុន្តែមិនតម្រូវឱ្យមាន API token ឬការតភ្ជាប់អ៊ីនធឺណិតទេ។

## នាំចូលពីគណនី Notion របស់អ្នក

### បង្កើត Notion API access token

ដើម្បីចូលប្រើទិន្នន័យ Notion របស់អ្នកតាម API អ្នកត្រូវការ access token។ ជំហាននេះត្រូវការពេលប្រហែលពីរនាទីដើម្បីបញ្ចប់។
...
6. នៅក្រោម **API token** ចុច **Link...** ដើម្បីបន្ថែម secret ថ្មី។ សម្រាប់ **ID** ដាក់ឈ្មោះដូចជា `notion` ហើយសម្រាប់ **Secret** បិទភ្ជាប់ **Access token** របស់អ្នកពី Notion។
...
1. ទៅកាន់ **Settings** នៅផ្នែកខាងលើនៃរបារចំហៀង Notion។
