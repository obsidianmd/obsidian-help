...
---
Obsidian lets you easily migrate your notes from Notion using the [[កម្មវិធីនាំចូល|Importer plugin]]. This will convert your Notion data to durable Markdown files that you can use offline with Obsidian and many other apps.

Obsidian offers two ways to import your Notion data:

1. **API import** preserves your entire workspace including Databases and formulas which are converted to [[ការណែនាំអំពី Bases|Bases]], but requires a Notion integration token and an internet connection.
...
1. Go to **[[ការកំណត់]]** at the top of the Notion sidebar.
