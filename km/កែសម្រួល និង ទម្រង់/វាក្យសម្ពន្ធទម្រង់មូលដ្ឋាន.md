...
Learn how to apply basic formatting to your notes, using [Markdown](https://daringfireball.net/projects/markdown/). For more advanced formatting syntax, refer to [[វាក្យសម្ពន្ធទម្រង់កម្រិតខ្ពស់]].
...
> Multiple adjacent blank spaces within and between paragraphs collapse into a single space when displayed in [[ទិដ្ឋភាព និងរបៀបកែសម្រួល#Reading view|Reading view]] or on [[ការណែនាំអំពី Obsidian Publish|Obsidian Publish]] sites.
> 
> ```md
...
Obsidian includes a **[[ការកំណត់#Strict line breaks|Strict line breaks]]** setting, which makes Obsidian follow the standard Markdown specification for line breaks.
...
To create a heading, add up to six `#` symbols before your heading text. The number of `#` symbols sets the level of the heading (as shown in the [[គ្រោង]]).
...
Text formatting can also be applied using [[ផ្លូវកាត់កែសម្រួល]].
...
Obsidian supports two formats for [[តំណភ្ជាប់ផ្ទៃក្នុង]] between notes:
...
> [!tip]- Tip
> If you want to add an image from inside your vault, you can also [[បង្កប់ឯកសារ#Embed an image in a note|embed an image in a note]].
...
> [!tip]- Tip
> You can turn your quote into a [[ប្រអប់រំលេច|callout]] by adding `[!info]` as the first line in a quote.
...
> [[ទិដ្ឋភាព និងរបៀបកែសម្រួល#Source mode|Source mode]] and [[ទិដ្ឋភាព និងរបៀបកែសម្រួល#Live Preview|Live Preview]] do not support PrismJS, and may render syntax highlighting differently.
...
To learn more advanced formatting syntax, such as tables, diagrams, and math expressions, refer to [[វាក្យសម្ពន្ធទម្រង់កម្រិតខ្ពស់]].
