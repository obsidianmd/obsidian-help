...
You can insert a table using the **Insert Table** command from the [[ក្ដារលាយពាក្យបញ្ជា|Command Palette]] or by right-clicking and selecting _Insert → Table_. This will give you a basic, editable table:
...
You can use [[វាក្យសម្ពន្ធទម្រង់មូលដ្ឋាន]] to style content within a table.

| First column       | Second column                           |
| ------------------ | --------------------------------------- |
| [[តំណភ្ជាប់ផ្ទៃក្នុង]] | Link to a file _within_ your **vault**. |
| [[បង្កប់ឯកសារ]]    | ![[Engelbart.jpg\|100]]                 |

> [!note] Vertical bars in tables
> If you want to use [[ឈ្មោះក្លែងក្លាយ]], or to [[វាក្យសម្ពន្ធទម្រង់មូលដ្ឋាន#External images|resize an image]] in your table, you need to add a `\` before the vertical bar.
>
> ```md
> First column | Second column
> -- | --
...
To add a Mermaid diagram, create a `mermaid` [[វាក្យសម្ពន្ធទម្រង់មូលដ្ឋាន#Code blocks|code block]].
...
You can create [[តំណភ្ជាប់ផ្ទៃក្នុង]] in your diagrams by attaching the `internal-link` [class](https://mermaid.js.org/syntax/flowchart.html#classes) to your nodes.
...
> [!note] Note
> Internal links from diagrams don't show up in the [[ទិដ្ឋភាពក្រាហ្វ]].
