...
To embed a YouTube video, use the same Markdown syntax as [[វាក្យសម្ពន្ធទម្រង់មូលដ្ឋាន#External images|external images]]:
...
To embed a tweet, use the same Markdown syntax as [[វាក្យសម្ពន្ធទម្រង់មូលដ្ឋាន#External images|external images]]:
