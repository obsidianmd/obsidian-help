...
- If an image looks too big in the note, make it smaller outside of Obsidian, or adjust its dimensions as explained in [[បង្កប់ឯកសារ#Embed an image in a note|embedding an image in a note]].
- In rare cases, you may want to place especially large or complex images in a [[ប្រអប់រំលេច#Foldable callouts|folded callout]]. 
