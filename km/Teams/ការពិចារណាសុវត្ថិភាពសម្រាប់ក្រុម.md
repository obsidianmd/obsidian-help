...
If you do not intend to use community plugins or themes, or [[ការណែនាំអំពី Obsidian Sync|Obsidian Sync]] or [[ការណែនាំអំពី Obsidian Publish|Obsidian Publish]], your standard procedures for securing applications will apply. However, if you plan to use any of these features, we recommend thoroughly evaluating their suitability for your workplace.

## Community plugins and themes

Please review the [[សុវត្ថិភាពកម្មវិធីជំនួយ]] page in addition to this section. 
...
We do not have a community store for [[ស្នីប៉ែត CSS]]. These files are typically obtained from within our [Obsidian Community](https://obsidian.md/community) or from public GitHub repositories.
...
Obsidian does not support SSO. In most use cases, Obsidian does not require an account or sign-on in your workplace, unless you are using [[ការណែនាំអំពី Obsidian Publish|Obsidian Publish]] or [[ការណែនាំអំពី Obsidian Sync|Obsidian Sync]].

**Does Obsidian support Multi-Factor Authentication (MFA)?**
Obsidian supports [[ការផ្ទៀងផ្ទាត់ ២ កត្តា]] (2FA) for Obsidian accounts, but it does not support 2FA for opening and using the base application. Users of [[ការណែនាំអំពី Obsidian Sync|Obsidian Sync]] and [[ការណែនាំអំពី Obsidian Publish|Obsidian Publish]] who have 2FA enabled will be required to confirm their 2FA key when they first log into the application.
...
However, you can waive this quoted purchase order amount by agreeing to pay a retainer fee. Please contact [[ជំនួយ និងការគាំទ្រ#Contact Obsidian support|Obsidian support]] to inquire about this option.
