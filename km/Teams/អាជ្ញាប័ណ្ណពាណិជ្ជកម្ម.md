...
Commercial licenses **are not** eligible for a refund per our [[គោលការណ៍សងប្រាក់វិញ]].
...
If you need an invoice for this transaction, you can [[ការណែនាំអំពីអាជ្ញាប័ណ្ណ និងការទូទាត់#Generate an invoice|generate an invoice]].

**Purchasing using a purchase order**

For purchases using a purchase order (PO), contact [[ជំនួយ និងការគាំទ្រ#Contact Obsidian support|Obsidian support]].
