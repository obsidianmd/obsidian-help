...
aliases:
  - Plugins/Graph view
---
Graph view is a [[កម្មវិធីជំនួយចម្បង|core plugin]] that lets you visualize the relationships between the notes in your vault.

To open the Graph view, click **Open graph view** in the [[រីបិន]].

- Circles represent notes, or _nodes_.
- Lines represent [[តំណភ្ជាប់ផ្ទៃក្នុង]] between two nodes.
...
- **Search files** lets you filter notes based on a search term. To learn about how you can write more advanced search terms, refer to [[ស្វែងរក]].
...
> [!info] Excluded files
> Files matching your [[ការកំណត់#Excluded files|Excluded files]] patterns will not appear in Graph view.
...
To learn about how you can write more advanced search terms, refer to [[ស្វែងរក]].
