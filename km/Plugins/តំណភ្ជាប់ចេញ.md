...
---
Outgoing links is a [[កម្មវិធីជំនួយចម្បង|core plugin]] that shows links from the active note at a glance, as well as potential links to be made. It's similar to the [[តំណភ្ជាប់ខាងក្រោយ]] plugin, which instead shows you _incoming_ links to the active note.
...
- **Unlinked mentions** lists any text in the active note that matches the name or [[ឈ្មោះក្លែងក្លាយ|alias]] of another note in your vault. Unlinked mentions helps you discover links you aren't aware of yet.

> [!info] Excluded files
> Files matching your [[ការកំណត់#Excluded files|Excluded files]] patterns will not appear in Unlinked mentions.
