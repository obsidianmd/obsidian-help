...
aliases:
  - Plugins/Backlinks
---
With the Backlinks [[កម្មវិធីជំនួយចម្បង|plugin]], you can see all the _backlinks_ for the active note.
...
- **Show search filter** toggles a text field that lets you filter the mentions. For more information on how to build a search term, refer to [[ស្វែងរក]].
...
> [!note] Note
> If you can't see the Backlinks tab, you can make it visible by opening the [[ក្ដារលាយពាក្យបញ្ជា]] and running the **Backlinks: Show backlinks** command.
