...
---
Quick switcher is a [[កម្មវិធីជំនួយចម្បង|core plugin]] that lets you search and open notes using only your keyboard.
...
> [!info] Excluded files
> Files matching your [[ការកំណត់#Excluded files|Excluded files]] patterns are deprioritized in Quick switcher results.
