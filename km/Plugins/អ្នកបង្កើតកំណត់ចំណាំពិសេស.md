...
---
Unique note creator is a [[កម្មវិធីជំនួយចម្បង|core plugin]] that lets you create notes with time-based names, also known as Zettelkasten notes.
...
1. Press `Ctrl+P` (or `Cmd+P` on macOS) to open the [[ក្ដារលាយពាក្យបញ្ជា]].
...
For more information about how to write templates, refer to [[Plugins/ពុម្ព]].
