...
- You can [[ផ្ទាំង#Arrange tabs|arrange tabs]] and split tab groups in the main content area and in [[របារចំហៀង|sidebars]].

### Drag sources

- You can drag a file, or multiple files from the [[កម្មវិធីរុករកឯកសារ]].
- You can drag a file from a [[ស្វែងរក]] result.
- You can drag a file from [[តំណភ្ជាប់ខាងក្រោយ]] or unlinked references.
...
- You can drop a file on a folder in the [[កម្មវិធីរុករកឯកសារ]] to move the file there.
...
- You can drop a file on the [[កំណត់ត្រា]] tab to bookmark it.
