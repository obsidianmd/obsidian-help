...
Hotkeys are different from [[ផ្លូវកាត់កែសម្រួល|system keyboard shortcuts]] (like `Ctrl+C` for copy), which are provided by your operating system and cannot be customized in Obsidian.

## View hotkeys

The fastest way to see the hotkey set for a command is to find the command in the [[ក្ដារលាយពាក្យបញ្ជា]]. If there's a hotkey listed for that command, it's set.

You can also view and manage all hotkeys in **[[ការកំណត់]] → Hotkeys**.

## Set a hotkey

To add or modify a hotkey:

1. Open **[[ការកំណត់]] → Hotkeys**.
...
To show only commands that have assigned hotkeys, select the filter icon in **[[ការកំណត់]] → Hotkeys**.
...
For a comprehensive list of default keyboard shortcuts for editing and navigation, see [[ផ្លូវកាត់កែសម្រួល]].
