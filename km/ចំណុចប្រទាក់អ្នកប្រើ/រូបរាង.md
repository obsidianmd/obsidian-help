...
Obsidian comes with two color schemes, light and dark. By default, the color scheme is set to adapt to your operating system. You can change this by going to **[[ការកំណត់]] → Appearance**.

### Custom themes

You can change the appearance of Obsidian by using [[រូបរាង|custom themes]]. Browse hundreds of community-made themes by going to **[[ការកំណត់]] → Appearance**, then click **Manage** to view and install themes.

You can also tweak themes using [[ស្នីប៉ែត CSS]] and [build your own theme](https://docs.obsidian.md/Themes/App+themes/Build+a+theme) .
