...
In the [[កម្មវិធីរុករកឯកសារ]], right-click a note and select **Open in new window**.

**Command palette:**

In the [[ក្ដារលាយពាក្យបញ្ជា]], select **Open current tab in new window**.
...
In the [[កម្មវិធីរុករកឯកសារ]], drag the file to a tab group in the destination window.

**Command palette:**

In the [[ក្ដារលាយពាក្យបញ្ជា]], select **Move current tab in new window**.
