...
> [!note] Mobile tabs
> On mobile, you can manage open tabs from the tab counter in the [[កម្មវិធីទូរសព្ទ#Navigation bar|Navigation bar]].
...
Every tab belongs to a _tab group_. You can drag and drop tabs to rearrange them within a tab group, move them to a different tab group, or create a new tab group. On desktop, you can drag tabs out of their window to open them in a separate [[បង្អួចលេចចេញ|pop-out window]].
...
To pin or unpin a tab in the sidebar, see [[របារចំហៀង#Pin tabs|pinning tabs in the sidebar]].
...
You can save and restore window layouts using the [[កន្លែងធ្វើការ]] plugin.
