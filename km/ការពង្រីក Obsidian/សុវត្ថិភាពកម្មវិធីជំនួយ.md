...
- If you discover any minor security vulnerabilities in a community plugin, refer to the plugin author's `security.md` or `readme.md` for how to report those. For Critical category flaws, please report the issue to [[ជំនួយ និងការគាំទ្រ#Contact Obsidian support|Obsidian support]] as well. 
- If you suspect that a community plugin is malicious, report it to [[ជំនួយ និងការគាំទ្រ#Contact Obsidian support|Obsidian support]], or by sending a DM to our moderators.
