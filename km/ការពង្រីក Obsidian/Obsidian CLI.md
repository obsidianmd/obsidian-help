...
> ការប្រើប្រាស់ CLI ត្រូវការកម្មវិធីដំឡើង Obsidian 1.12។ សូមមើល [[Update Obsidian#Installer updates|ការណែនាំអំពីការអាប់ដេតកំណែកម្មវិធីដំឡើង]]។

## ដំឡើង Obsidian CLI

ធ្វើបច្ចុប្បន្នភាពទៅ [[Update Obsidian|កំណែកម្មវិធីដំឡើង Obsidian]] ចុងក្រោយបំផុត (1.12.7+)។
