...
Upgrade to the latest [[អាប់ដេត Obsidian|Obsidian installer version]] (1.11.7) and the latest [[កំណែចូលប្រើមុន|early access version]] (1.12.x).
...
- Make sure you are using the latest [[អាប់ដេត Obsidian|Obsidian installer version]] (1.12.4 or above).
...
Obsidian CLI on Windows requires the Obsidian 1.12.4+ installer. See [[អាប់ដេត Obsidian|Installer version update]].
