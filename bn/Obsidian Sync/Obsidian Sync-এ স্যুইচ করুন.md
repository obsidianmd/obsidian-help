...
> আমরা iCloud, Dropbox, OneDrive, Google Drive-এর মতো ক্লাউড স্টোরেজ সার্ভিসের পাশাপাশি Obsidian Sync ব্যবহার করার [[সচরাচর জিজ্ঞাসিত প্রশ্ন#Can I use a third-party sync with Obsidian Sync?|পরামর্শ দিই না]] কারণ এতে কনফ্লিক্ট হতে পারে। তবে, ক্লাউড স্টোরেজ সার্ভিসগুলো আপনার [[আপনার Obsidian ফাইল ব্যাকআপ করুন|ব্যাকআপ]] কৌশলে ভূমিকা রাখতে পারে।
...
![[ভল্ট পরিচালনা#Move vault to a different folder]]
...
> [!note] আপনার যদি ইতিমধ্যে অন্য একটি ডিভাইসে ডেটা থাকে এবং Obsidian Sync সেটআপ করা থাকে, তাহলে পরিবর্তে [[Obsidian Sync সেটআপ করুন#Sync a remote vault on another device|Sync থেকে একটি নতুন লোকাল ভল্ট সেটআপ করা]] প্রস্তাবিত।

- আপনার ভল্ট [[আপনার Obsidian ফাইল ব্যাকআপ করুন|ব্যাকআপ]] করুন।
...
- Obsidian Sync দিয়ে শুরু করতে চান? [[Obsidian Sync সেটআপ করুন]]
- এখনও সহায়তা প্রয়োজন? দেখুন [[Obsidian Sync সমস্যা সমাধান]]
