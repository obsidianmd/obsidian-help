...
---
[[Obsidian Sync পরিচিতি|Obsidian Sync]] ডেস্কটপ অ্যাপ ব্যবহার না করেই ভল্ট সিঙ্ক করার জন্য একটি হেডলেস ক্লায়েন্ট প্রদান করে। CI পাইপলাইন, এজেন্ট এবং স্বয়ংক্রিয় ওয়ার্কফ্লোর জন্য উপযোগী। সর্বশেষ পরিবর্তনগুলো সিঙ্ক করুন অথবা ফাইলগুলো ক্রমাগত আপ টু ডেট রাখুন।

Obsidian ডেস্কটপ অ্যাপ ছাড়াই কমান্ড লাইন থেকে [[Obsidian Sync পরিচিতি|Obsidian Sync]]-এর সাথে ইন্টারঅ্যাক্ট করতে [[Obsidian Headless]] **(ওপেন বিটা)** ইনস্টল করুন। Headless Sync ডেস্কটপ অ্যাপের মতোই একই [[নিরাপত্তা ও গোপনীয়তা|এনক্রিপশন এবং প্রাইভেসি সুরক্ষা]] ব্যবহার করে, এন্ড-টু-এন্ড এনক্রিপশন সহ।
...
আপনার একটি সক্রিয় [[প্ল্যান ও স্টোরেজ সীমা|Obsidian Sync সাবস্ক্রিপশন]] থাকতে হবে।
...
| `--region` | সার্ভার [[সিঙ্ক অঞ্চল\|অঞ্চল]] (বাদ দিলে স্বয়ংক্রিয়) |
...
| `--device-name` | [[ভার্সন ইতিহাস\|সিঙ্ক ভার্সন ইতিহাসে]] প্রদর্শিত ডিভাইসের নাম |
| `--config-dir` | [[কনফিগারেশন ফোল্ডার\|কনফিগ ডিরেক্টরি]]-এর নাম (ডিফল্ট: `.obsidian`) |
...
একটি ভল্টের জন্য [[সিঙ্ক সেটিংস ও নির্বাচিত সিঙ্কিং|সিঙ্ক সেটিংস]] দেখুন বা পরিবর্তন করুন। বর্তমান কনফিগারেশন প্রদর্শনের জন্য কোনো অপশন ছাড়াই চালান।
