...
Obsidian ডেস্কটপ অ্যাপ ছাড়াই কমান্ড লাইন থেকে [[Obsidian Sync পরিচিতি|Obsidian Sync]]-এর সাথে ইন্টারঅ্যাক্ট করতে [[Obsidian Headless]] **(ওপেন বিটা)** ইনস্টল করুন। Headless Sync ডেস্কটপ অ্যাপের মতোই একই [[Security and privacy|এনক্রিপশন এবং প্রাইভেসি সুরক্ষা]] ব্যবহার করে, এন্ড-টু-এন্ড এনক্রিপশন সহ।
