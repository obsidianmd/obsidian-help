...
> যদি আপনি টেবিলে [[aliases|উপনাম]] ব্যবহার করতে চান, অথবা [[মৌলিক ফরম্যাটিং সিনট্যাক্স#External images|একটি ছবির আকার পরিবর্তন]] করতে চান, তাহলে উল্লম্ব রেখার আগে একটি `\` যোগ করতে হবে।
>
> ```md
> First column | Second column
> -- | --
