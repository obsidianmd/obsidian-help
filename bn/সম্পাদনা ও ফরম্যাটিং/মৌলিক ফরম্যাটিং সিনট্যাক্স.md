...
[Markdown](https://daringfireball.net/projects/markdown/) ব্যবহার করে আপনার নোটে কীভাবে বেসিক ফরম্যাটিং প্রয়োগ করবেন তা জানুন। আরও অ্যাডভান্সড ফরম্যাটিং সিনট্যাক্সের জন্য, [[উন্নত ফরম্যাটিং সিনট্যাক্স]] দেখুন।
...
> অনুচ্ছেদের মধ্যে এবং অনুচ্ছেদগুলোর মধ্যে একাধিক পাশাপাশি খালি স্পেস [[ভিউ ও সম্পাদনা মোড#Reading view|রিডিং ভিউ]]-এ বা [[Obsidian Publish পরিচিতি|Obsidian Publish]] সাইটে প্রদর্শনের সময় একটি মাত্র স্পেসে সংকুচিত হয়ে যায়।
> 
> ```md
...
Obsidian-এ একটি **[[সেটিংস#Strict line breaks|Strict line breaks]]** সেটিং রয়েছে, যা Obsidian-কে লাইন ব্রেকের জন্য স্ট্যান্ডার্ড Markdown স্পেসিফিকেশন অনুসরণ করায়।
...
একটি হেডিং তৈরি করতে, আপনার হেডিং টেক্সটের আগে সর্বোচ্চ ছয়টি `#` চিহ্ন যোগ করুন। `#` চিহ্নের সংখ্যা হেডিংয়ের লেভেল নির্ধারণ করে ([[রূপরেখা|রূপরেখা]]-এ দেখানো হয়েছে)।
...
[[সম্পাদনা শর্টকাট]] ব্যবহার করেও টেক্সট ফরম্যাটিং প্রয়োগ করা যায়।
...
নোটগুলোর মধ্যে [[ইন্টারনাল লিঙ্ক|ইন্টার্নাল লিঙ্ক]]-এর জন্য Obsidian দুটি ফরম্যাট সমর্থন করে:
...
> [!tip]- টিপ
> যদি আপনি আপনার ভল্টের ভেতর থেকে একটি ছবি যোগ করতে চান, তাহলে আপনি [[ফাইল এম্বেড করুন#Embed an image in a note|নোটে একটি ছবি এমবেডও]] করতে পারেন।
...
> [!tip]- টিপ
> উদ্ধৃতির প্রথম লাইনে `[!info]` যোগ করে আপনি আপনার উদ্ধৃতিকে একটি [[কলআউট|কলাউটে]] পরিণত করতে পারেন।
...
> [[ভিউ ও সম্পাদনা মোড#Source mode|সোর্স মোড]] এবং [[ভিউ ও সম্পাদনা মোড#Live Preview|লাইভ প্রিভিউ]] PrismJS সমর্থন করে না, এবং সিনট্যাক্স হাইলাইটিং ভিন্নভাবে রেন্ডার করতে পারে।
...
একটি নোটের সমস্ত ফুটনোট দেখতে [[পাদটীকা ভিউ]] ব্যবহার করুন।
...
টেবিল, ডায়াগ্রাম, এবং গাণিতিক এক্সপ্রেশনের মতো আরও অ্যাডভান্সড ফরম্যাটিং সিনট্যাক্স সম্পর্কে জানতে, [[উন্নত ফরম্যাটিং সিনট্যাক্স]] দেখুন।
