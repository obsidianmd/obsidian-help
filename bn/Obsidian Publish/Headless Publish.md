...
---
[[Obsidian Publish পরিচিতি|Obsidian Publish]] ডেস্কটপ অ্যাপ ব্যবহার না করে ভল্ট প্রকাশ করার জন্য একটি হেডলেস ক্লায়েন্ট সরবরাহ করে। CI পাইপলাইন এবং স্বয়ংক্রিয় ওয়ার্কফ্লোর জন্য উপযোগী। একটি নির্ধারিত সময়সূচি অনুযায়ী বা একটি বিল্ড পাইপলাইনের অংশ হিসেবে আপনার সর্বশেষ পরিবর্তনগুলো প্রকাশ করুন।

Obsidian ডেস্কটপ অ্যাপ ছাড়াই কমান্ড লাইন থেকে [[Obsidian Publish পরিচিতি|Obsidian Publish]]-এর সাথে ইন্টার‍্যাক্ট করতে [[Obsidian Headless]] **(ওপেন বিটা)** ইনস্টল করুন।
...
আপনার একটি সক্রিয় [[Obsidian Publish পরিচিতি|Obsidian Publish সাবস্ক্রিপশন]] থাকতে হবে।
