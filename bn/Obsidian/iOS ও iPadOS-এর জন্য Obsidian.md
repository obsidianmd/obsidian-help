...
- **Open Bookmark** - আপনার ভল্ট থেকে একটি বুকমার্ক করা নোট খুলুন
- **Open New Note** — আপনার ভল্টে একটি নতুন নোট তৈরি করুন
...
- **Get Bookmarked Note** — একটি বুকমার্ক করা নোট থেকে টেক্সট পায়
- **Get Daily Note** — একটি দৈনিক নোট থেকে টেক্সট পায়
- **Search Vault** — একটি কীওয়ার্ড দিয়ে আপনার ভল্টে অনুসন্ধান করুন
- **Bookmark Link** — আপনার বুকমার্কে একটি ওয়েব লিঙ্ক যোগ করুন
- **Open Obsidian** — Obsidian খোলে
