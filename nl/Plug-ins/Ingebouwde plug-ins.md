...
publish: true
mobile: true
description: 'Deze pagina bevat een overzicht van de kernplug-ins die standaard met Obsidian worden meegeleverd, en de community-plug-ins die zij ook onderhouden.'
---
Deze pagina toont de kernplug-ins die standaard met Obsidian worden meegeleverd. Kernplug-ins zijn officieel gebouwd en ondersteund door het Obsidian-team en zijn opgenomen in de applicatie.

Sommige kernplug-ins zijn standaard uitgeschakeld. Je kunt ze activeren via **[[Instellingen]] → Ingebouwde plug-ins**.

Het Obsidian-team onderhoudt ook de ontwikkeling van bepaalde [[#Overige plug-ins|open-source community-plugins]].

> [!tip] Communityplug-ins
> Als je de gewenste plug-in hier niet kunt vinden, bekijk dan enkele van de [[Communityplug-ins|plug-ins gebouwd door de community]]. Je kunt ook zelf [een plug-in bouwen](https://docs.obsidian.md/Plugins/Getting+started/Build+a+plugin).
