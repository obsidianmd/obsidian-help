...
> [!提示] 不过，我们伟大的[社区](https://obsidian.md/zh/community)成员已经想出了一些解决这一限制的方法，我们正在尝试中。
...
为了提升访客的体验，我们建议你使用专门的视频服务网站，比如 YouTube 、Vimeo 或 Bilibili。
...
此外，发布服务目前不支持应用程序中的[[搜索#在笔记中嵌入搜索结果|嵌入搜索结果]]功能。
