...
Obsidian 正在尝试连接到你远程仓库的[[Obsidian Sync/同步安全和隐私#Where can I find my current Sync server and where is it hosted?|同步服务器]]。
...
Obsidian Sync 检测到你当前未登录。你需要在**[[设置文件夹|设置]]**的[[Settings#General#Account|账户]]部分重新登录应用。
