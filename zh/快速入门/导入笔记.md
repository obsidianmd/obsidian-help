...
- <span class="icon-app icon-apple-journal"></span> [[从 Apple Journal 导入|Apple Journal]]
...
- <span class="icon-app icon-craft"></span> [[从 Craft 导入|Craft]]
...
- <span class="icon-app icon-md"></span> [[导入 CSV 文件]]
- <span class="icon-app icon-md"></span> [[导入 Markdown 文件|Markdown 文件]]
- <span class="icon-app icon-md"></span> [[导入 Textbundle 文件|Textbundle 文件]]
