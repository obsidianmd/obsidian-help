...
2. 在 [Billing](https://obsidian.md/zh/account/billing) 部分，找到 **Obsidian Credit**，选择 **Buy credit**。
...
2. 前往账户的 [Billing](https://obsidian.md/zh/account/billing) 部分，选择 **Send credit**。
...
1. 登录或创建[你的 Obsidian 账户](https://obsidian.md/zh/account/billing)。
2. 打开兑换链接或点击邮件中的链接。
3. 确认你要接收积分。
4. 积分将存入你的账户，可以随时使用。
