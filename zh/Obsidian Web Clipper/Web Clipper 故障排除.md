...
---
如果你在使用 [[Introduction to Obsidian Web Clipper|Web Clipper]] 时遇到问题，可以通过[官方 Discord 频道](https://discord.com/channels/686053708261228577/1285652864089198672)获取帮助。你也可以在 [GitHub 仓库](https://github.com/obsidianmd/obsidian-clipper)中报告问题。
...
- [[Highlight web pages|高亮内容]]以精确选择你想要抓取的内容。
...
- 检查 Obsidian [[帮助与支持#Capture console logs|开发者控制台]]中是否有错误。
...
- 确保 [[Obsidian URI]] 协议[[Obsidian URI#Register Obsidian URI|已注册]]。
