...
cssclasses:
  - soft-embed
---
使用[[迁移助手|Importer 插件]]，你可以轻松将 Microsoft OneNote 中的笔记迁移到 Obsidian。这会把你 OneNote 中的笔记转换成 Markdown 文件，从而让这些数据能被 Obsidian 等一系列软件读取和应用。
...
使用 [[导入器模板|Importer 模板]] 可以完全自定义 OneNote 数据的导入方式。
