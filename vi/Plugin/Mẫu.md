...
Sử dụng lệnh `Mẫu: Chèn ngày hiện tại` và `Mẫu: Chèn thời gian hiện tại` để chèn ngày và thời gian hiện tại tại vị trí con trỏ hiện tại. Giống như lệnh `Chèn mẫu`, điều này có thể thực hiện bằng [[Khay lệnh]] hoặc [[Phím tắt#Thiết lập phím tắt|phím tắt tùy chỉnh]].
