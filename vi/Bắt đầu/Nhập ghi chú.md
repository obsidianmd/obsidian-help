...
cssclasses:
  - list-cards
---
Các ứng dụng đến rồi đi, nhưng dữ liệu của bạn nên tồn tại lâu dài. Obsidian sử dụng các tệp Markdown văn bản thuần không độc quyền được lưu trữ cục bộ trên thiết bị của bạn. Bạn có toàn quyền kiểm soát dữ liệu của mình, điều đó có nghĩa là bạn có thể sử dụng Obsidian ngoại tuyến và dễ dàng chuyển sang ứng dụng khác nếu cần.
...
- <span class="icon-app icon-apple-journal"></span> [[Nhập từ Apple Journal|Apple Journal]]
- <span class="icon-app icon-google-keep"></span> [[Nhập từ Google Keep|Google Keep]]
...
Không thấy ứng dụng của bạn? Bạn có thể yêu cầu hoặc đóng góp vào [kho mã nguồn mở](https://github.com/obsidianmd/obsidian-importer) cho plugin [[Trình nhập]].

Các hướng dẫn bổ sung đã được cộng đồng chia sẻ có thể giúp bạn di chuyển sang Obsidian:
