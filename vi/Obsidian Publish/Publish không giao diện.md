...
cssclasses:
  - reference
description: Obsidian Publish cung cấp một ứng dụng headless để xuất bản kho ghi chú mà không cần sử dụng ứng dụng máy tính. Hữu ích cho các quy trình CI và luồng công việc tự động.
---
