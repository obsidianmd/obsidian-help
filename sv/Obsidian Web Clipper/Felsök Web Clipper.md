...
- Om du använder Flatpak kan du behöva uppdatera värdet `x-scheme-handler/obsidian` i din `.config/mimeapps.list` från `obsidian.desktop` till `md.obsidian.Obsidian.desktop`.
