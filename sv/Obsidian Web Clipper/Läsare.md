...
Läsaren extraherar det huvudsakliga innehållet från sidan. Den ursprungliga sidan ersätts med en ren läsvy som inkluderar:

- Artikelns titel, författare, publiceringsdatum och källdomän.
- Det huvudsakliga artikelinnehållet, med bilder och formatering bevarade.
- En disposition i sidofältet för artiklar med flera rubriker.
