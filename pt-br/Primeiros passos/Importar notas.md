...
aliases:
  - Como/Importar dados
---
Aplicativos vêm e vão, mas seus dados devem durar. O Obsidian usa arquivos Markdown de texto simples não proprietários armazenados localmente no seu dispositivo. Você tem total controle sobre seus dados, o que significa que pode usar o Obsidian offline e mudar para outro aplicativo facilmente se precisar.

## Importar de outros aplicativos e formatos de arquivo
...
Não encontrou seu aplicativo? Você pode solicitar ou contribuir para o [repositório de código aberto](https://github.com/obsidianmd/obsidian-importer) do plugin [[Importador]].

Guias adicionais foram compartilhados pela nossa comunidade que podem ajudá-lo a migrar para o Obsidian:
