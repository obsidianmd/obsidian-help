...
To embed a file in your vault, add an exclamation mark (`!`) in front of an [[Links internos|Internal link]]. You can embed files in any of the [[Formatos de arquivos aceitos]].
...
You can also embed links to [[Links internos#Link to a heading in a note|headings]] and [[Links internos#Link to a block in a note|blocks]].
