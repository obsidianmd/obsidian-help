...
Obsidian Syncを使用している各保管庫の最大サイズは4GBです。このエラーは、保管庫がそのサイズ限度を超えてしまっていることを指し示しています。添付ファイルとバージョン履歴が容量に寄与しているため、保管庫の実際のサイズが4GB以下だとしても4GBの限界を超えてしまっていることがあることに注意してください。
