...
---
Obsidianでは、公式の[[インポーター|インポータープラグイン]]を使用して、個々のHTMLファイルやHTMLファイルのフォルダ全体を簡単にインポートできます。これはウェブサイト全体を[[Obsidian フレーバー Markdown|Markdown]]フォーマットで保存したい場合や、HTMLにエクスポートするツールからデータをインポートしたい場合に便利です。
