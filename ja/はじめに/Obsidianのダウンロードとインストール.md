...
1. ブラウザを開き、[Obsidianのダウンロード](https://obsidian.md/ja/download)にアクセスします。
...
オプションとして、[Obsidianのダウンロード](https://obsidian.md/ja/download)ページからAndroid用のAPKをダウンロードすることもできます。
