...
cssclasses:
  - list-cards
---
Les aplicacions van i vénen, però les teves dades haurien de perdurar. Obsidian utilitza fitxers Markdown de text sense format no propietaris emmagatzemats localment al teu dispositiu. Tens control total sobre les teves dades, la qual cosa vol dir que pots fer servir Obsidian fora de línia i canviar a una altra aplicació fàcilment si mai ho necessites.
...
- <span class="icon-app icon-apple-journal"></span> [[Importar des d'Apple Journal|Apple Journal]]
- <span class="icon-app icon-google-keep"></span> [[Importar des de Google Keep|Google Keep]]
...
No veus la teva aplicació? Pots sol·licitar-la o contribuir al [repositori de codi obert](https://github.com/obsidianmd/obsidian-importer) del connector [[Importador]].

La nostra comunitat ha compartit guies addicionals que et poden ajudar a migrar a Obsidian:
