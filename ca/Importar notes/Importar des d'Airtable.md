...
Per accedir a les teves dades d'Airtable a través de l'API necessites un token d'accés personal. Aquest pas triga aproximadament dos minuts a completar.
