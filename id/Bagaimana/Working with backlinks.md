...
As you can see, from this document, there is currently one entry in each section. Under Linked mentions you can see that I made a link to this document in the [[Panel terhubung]] note. But, you can also see under Unlinked mentions that I wrote the name of this note but did not make it a link.
...
You can also create a separate, dedicated backlinks pane for a note under the More Options menu. This will be [[Panel terhubung]] connected to the note, and can be moved around anywhere, as described in [[Tata letak panel]]. There's also an option to do this in the [[Palet perintah]].
