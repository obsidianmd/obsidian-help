...
Aside from that, though, you can create a vault anywhere your operating system allows. Obsidian files sync fine with Dropbox, iCloud, OneDrive, git, and every other syncing service we've tried thus far.

### Symbolic Links

Starting in v0.11.1, Obsidian recognizes symbolic links and junctions. We don't officially recommend using these, but we recognize there are valid use-cases for them. Use them at your own risk.
