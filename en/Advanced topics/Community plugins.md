...
Please be aware that third-party plugins can access files on your computer, connect the internet, and even install additional programs. To read more about plugin security, [[Advanced topics/Community plugins#Plugin security|see here]].
