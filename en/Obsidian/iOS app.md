...
The Obsidian mobile app for iOS brings powerful note-taking capabilities to your iPhone and iPad. This page covers iOS-specific features including widgets, Siri integration, and Shortcuts.
...
Obsidian for iOS offers several widget options to quickly access your vault without opening the app.
...
Available on iOS 18 or higher, Home Screen widgets allow you to:
- Create a note
- View a note
...
- **Capture to a note** — Append or prepend text to a note without opening the Obsidian app
