...
- Usar el menú contextual para acceder a todas las operaciones disponibles.
...
1. Haz clic derecho en la carpeta y luego haz clic en **Nueva nota**.
2. Escribe el nombre de la nota y luego presiona Enter.
...
1. Haz clic derecho en la carpeta donde deseas crear la subcarpeta y luego haz clic en **Nueva carpeta**.
2. Escribe el nombre de la carpeta y luego presiona Enter.
...
1. Haz clic derecho en el archivo que deseas eliminar y luego haz clic en **Eliminar**.
2. Si se te solicita confirmar que deseas eliminar el archivo, haz clic en **Eliminar**.

Para más información, consulta [[Gestionar notas#Eliminar una nota|Eliminar una nota]].

## Renombrar un archivo o carpeta

1. Haz clic derecho en el archivo que deseas renombrar y luego haz clic en **Editar nombre del archivo**.
