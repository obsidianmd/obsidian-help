...
5. Tu clave de licencia se mostrará y puede activarse siguiendo los pasos a continuación.

Si necesitas una factura para esta transacción, puedes [[Introducción a licencias y pagos#Generar una factura|generar una factura]].

**Comprar usando una orden de compra**

Para compras usando una orden de compra (OC), contacta al [[Ayuda y soporte#Contactar al soporte de Obsidian|soporte de Obsidian]].

Tu OC debe incluir:

- Nombre legal de tu empresa (nombre de facturación)
- Dirección de facturación
- Número de IVA (opcional)
- Términos de pago (por defecto es 30 días netos)
- Número de OC/Referencia
- Correo electrónico de entrega para licencias
...
Para aplicar opcionalmente una licencia comercial a tu instalación de Obsidian, sigue los pasos a continuación. Ten en cuenta que aplicar una licencia comercial no proporciona ningún beneficio funcional dentro de la aplicación.

1. Abre la aplicación de Obsidian.
2. Ve a **[[Configuración]] → General → Licencia comercial**.
3. Haz clic en **Activar** e introduce tu clave de licencia.
4. ¡Listo! La aplicación ahora tiene licencia para uso comercial.
...
**¿Qué nombre de empresa debo usar si estoy comprando la licencia yo mismo?**
Usa el nombre de tu empresa para la licencia si esperas ser reembolsado por tu empresa.
...
**¿Estoy obligado a comprar una licencia comercial para cada empleado?**
No. Obsidian es 100% gratuito de usar, por lo que no se requiere una compra mínima de puestos.

**¿Puedo usar la licencia comercial que compré tanto en mi teléfono de trabajo como en mi computadora de trabajo?**
Sí. La licencia comercial se cobra por número de puestos, no por dispositivo. Esto significa que puedes usar la misma clave de licencia en todos tus dispositivos de trabajo individuales.

**Trabajo en un entorno de alta seguridad, en una red aislada. ¿Cómo aplico mi licencia comercial?**
En tales entornos especializados, no necesitas aplicar la licencia comercial directamente a tu instalación.
