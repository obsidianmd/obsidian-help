Una de las cosas que hace que Obsidian sea diferente de otras aplicaciones para tomar notas es lo fácil que es abrir varios archivos en su configuración preferida.
