...
El Lector extrae el contenido principal de la página. La página original se reemplaza con una vista de lectura limpia que incluye:

- El título del artículo, autor, fecha de publicación y dominio de origen.
- El contenido principal del artículo, con imágenes y formato preservados.
- Un esquema en la barra lateral para artículos con múltiples encabezados.
