Los nombres no se enumeran por cantidad de contribución, sino alfabéticamente (¡o al menos lo intentamos!).
...
La primera versión de la bóveda de ayuda fue escrita por Silver. Posteriormente, parte de ella fue escrita por [@mediapathic](http://mediapathic.net), con una gran ayuda de Reggie. También obtuvimos correcciones de los muchos pares de ojos en la comunidad de Discord y foros.

Ahora aceptamos solicitudes de extracción a la bóveda de ayuda en [our docs repo](https://github.com/obsidianmd/obsidian-docs/).

##### Agregue su nombre

Si es traductor, realice una solicitud de extracción para agregar "Su nombre (idioma en el que se contribuyó)" a la sección anterior. Por favor mantenga la lista de nombres en orden alfabético, ¡gracias!

Si su nombre no está en inglés y no se puede enumerar alfabéticamente, use este formato: `your-github-username, [your name in your language] (Language name)`.
