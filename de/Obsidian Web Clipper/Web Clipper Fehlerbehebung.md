...
- Wenn du das Flatpak verwendest, musst du möglicherweise den Wert `x-scheme-handler/obsidian` in deiner `.config/mimeapps.list` von `obsidian.desktop` auf `md.obsidian.Obsidian.desktop` ändern.
