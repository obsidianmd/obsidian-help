...
6. Klicke unter **API token** auf **Verknüpfen...**, um ein neues Geheimnis hinzuzufügen. Gib als **ID** einen Namen wie `notion` ein, und füge als **Geheimnis** dein **Internal Integration Secret** von Notion ein.
