...
cssclasses:
  - soft-embed
---
Unsere [Sicherheits](https://obsidian.md/security)-Seite fasst Informationen darüber zusammen, wie Obsidian den Schutz Ihrer Daten handhabt. Sie ist auch die Anlaufstelle für Sicherheitsaudits, die von Dritten durchgeführt wurden.
...
Wenn Sie nicht vorhaben, Community-Erweiterungen oder -Themen zu verwenden, oder [[Einführung in Obsidian Sync|Obsidian Sync]] oder [[Einführung in Obsidian Publish|Obsidian Publish]], gelten Ihre Standardverfahren zur Absicherung von Anwendungen. Wenn Sie jedoch planen, eine dieser Funktionen zu nutzen, empfehlen wir, deren Eignung für Ihren Arbeitsplatz gründlich zu prüfen.

## Community-Erweiterungen und Themen

Bitte lesen Sie zusätzlich zu diesem Abschnitt die Seite [[Plugin-Sicherheit]].
...
Obwohl wir den Local-First-Ansatz unserer Anwendung priorisieren, stellt Obsidian Netzwerkverbindungen basierend auf den von Ihnen genutzten Diensten und Funktionen her. Diese Netzwerkverbindungen können über eine Domain-Firewall oder Anwendungssperre deaktiviert werden.

Obsidian stellt diese Netzwerkverbindungen über HTTPS-Port 443 her.

Im Folgenden finden Sie eine Liste der Netzwerkverbindungen, die Obsidian herstellt.

### Von Obsidian ausgehende Verbindungen

- **Vorabversions-Updates**: Verwendet `releases.obsidian.md`.
- **Konto- und Lizenzverwaltung**: Beim Zugriff auf Ihr Obsidian-Konto in den Einstellungen und beim Anwenden einer kommerziellen Lizenz rufen wir `api.obsidian.md` auf.
- **Obsidian Sync**: Wird zum Synchronisieren Ihrer Notizen über Geräte hinweg verwendet.
...
Obsidian unterstützt kein SSO. In den meisten Anwendungsfällen benötigt Obsidian kein Konto oder keine Anmeldung an Ihrem Arbeitsplatz, es sei denn, Sie verwenden [[Einführung in Obsidian Publish|Obsidian Publish]] oder [[Einführung in Obsidian Sync|Obsidian Sync]].
...
Sie können diesen Mindestbestellwert jedoch umgehen, indem Sie eine Vorabgebühr zahlen. Bitte kontaktieren Sie den [[Hilfe und Support#Obsidian-Support kontaktieren|Obsidian-Support]], um sich nach dieser Option zu erkundigen.
