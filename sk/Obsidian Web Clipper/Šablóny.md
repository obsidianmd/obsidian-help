...
Keď je povolená [[Interpretácia webových stránok|Interpretácia]], môžete použiť [[Premenné#Prompt variables|premenné výziev]] na extrahovanie obsahu stránky pomocou prirodzeného jazyka. Pre každú šablónu môžete definovať [[Interpretácia webových stránok#Context|kontext]], ku ktorému má interpreter prístup.
