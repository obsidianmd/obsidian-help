Nomes não estão listados por quantidade de contribuição, mas alfabeticamente (pelo menos nós tentamos!).
...
Créditos a esses desenvolvedores de plugins por serem prioneiros nas funcionalidades que nós adaptamos ao Obsidian:

- pjeby pelo plugin Hotkey Helper
- javalent pelo plugin Admonition
- NothingIsLost por diversas melhoras no plugin  CodeMirror 6 
- mgmeyers pelo plugin Indentation Guides

## Builds

- jstone por manter nossas builds no flathub
- adamgibbins and ran-dall por manter nossas builds no homebrew
...
- Vinicius de Freitas (Brazilian Portuguese)
- yo-goto, ぱだわん (Japanese)


## Documentação

A primeira versão desse cofre de ajuda foi escrita por Silver. Parte posterior foi escrita por [@mediapathic](http://mediapathic.net), com grande ajuda de Reggie. Nós também tivemos correções de muitos pares de olhos no Discord e do fórum da comunidade.

A documentação é atualmente mantida por [Marcus Olsson](https://marcus.se.net/).

Nós agora aceitamos pull requests para o cofre de ajuda em [our docs repo](https://github.com/obsidianmd/obsidian-docs/).

### Adicione seu nome

Se você é um tradutor, por favor faça um pull request para adicionar "Seu nome (língua contribuída)" na seção acima. Por favor, mantenha a lista de nomes em ordem alfabética, obrigado!

Se seu nome não é em Inglês e não pode ser listado alfabeticamente, use esse formato: `seu-nome-de-usuário-github, [seu nome em sua língua] (Nome da língua)`.

## Reconhecimento de terceiros

O logo do Obsidian é adaptado de:
...
O Obsidian usa as bibliotecas de código aberto abaixo (em ordem alfabética):
