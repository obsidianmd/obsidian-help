The Outgoing links plugin shows the links from the active note at a glance, as well as potential links to be made. It's similar to the [[Links inversos]] plugin, which instead shows you _incoming_ links to the active note.
