...
- **Note-first approach**. If you need to create a note, you can do so in [[Explorador de arquivos]]. The keyboard shortcut is `Ctrl/Cmd+N`. Also, if you have the [[Command palette]] plugin enabled (it's on by default), press `Ctrl/Cmd-p` and type ‘new’, then select **********
...
If you already have folders set up in [[Explorador de arquivos]], you can right-click on a folder to create notes inside it:
