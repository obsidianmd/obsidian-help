...
Please note that only [[Formatos de arquivo suportados]] are handled.
...
Alternatively, you can right click on a folder in [[Explorador de arquivos]] and choose "Set as attachment folder".
