...
>
> If you want to sync vault configuration, such as settings for [[Plugins nativos]], [[Custom hotkeys]], or [[Plugins da comunidade]], learn how to [[Select files and settings to sync#Sync vault configuration|Sync vault configuration]].
