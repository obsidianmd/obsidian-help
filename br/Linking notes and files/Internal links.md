...
While you can link to any of the [[Formatos de arquivo suportados]], links to file formats other than Markdown needs to include a file extension, such as `[[Figure 1.png]]`.
