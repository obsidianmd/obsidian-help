...
Obsidian URI is a custom URI protocol supported by Obsidian that lets you trigger Obsidian URI is a custom URI protocol supported by Obsidian that lets you trigger various actions, such as opening a note or creating a note.
...
This Obsidian URI endpoint opens [[البحث|Search]] in the specified vault, and optionally perform a search query.

### Examples

- `obsidian://search?vault=my%20vault`
	This opens the vault `my vault`, and opens [[البحث|Search]].

- `obsidian://search?vault=my%20vault&query=Obsidian`
	This opens the vault `my vault`, opens [[البحث|Search]], and performs a search for `Obsidian`.
