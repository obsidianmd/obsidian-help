...
- <span class="icon-app icon-airtable"></span> [[الاستيراد من Airtable|Airtable]]
- <span class="icon-app icon-onenote"></span> [[استيراد من Microsoft OneNote|Microsoft OneNote]]
- <span class="icon-app icon-evernote"></span> [[استيراد من  Evernote|Evernote]]
- <span class="icon-app icon-apple-notes"></span> [[استيراد من Apple Notes|Apple Notes]]
- <span class="icon-app icon-apple-journal"></span> [[استيراد من Apple Journal|Apple Journal]]
...
- <span class="icon-app icon-craft"></span> [[استيراد من Craft|Craft]]
- <span class="icon-app icon-roam"></span> [[استيراد من Roam Research|Roam Research]]
- <span class="icon-app icon-logseq"></span> [[استيراد من Logseq|Logseq]]
- <span class="icon-app icon-md"></span> [[استيراد من Tomboy وGnote|Tomboy وGnote]]
- <span class="icon-app icon-html"></span> [[استيراد ملفات HTML|ملفات HTML]]
- <span class="icon-app icon-md"></span> [[استيراد ملفات CSV]]
- <span class="icon-app icon-md"></span> [[استيراد ملفات Markdown|ملفات Markdown]]
- <span class="icon-app icon-md"></span> [[استيراد ملفات Textbundle|ملفات Textbundle]]
