...
- <span class="icon-app icon-roam"></span> [[استيراد من Microsoft OneNote|Roam Research]]
- <span class="icon-app icon-onenote"></span> [[استيراد من  Evernote|Microsoft OneNote]]
- <span class="icon-app icon-evernote"></span> [[استيراد من  Apple Notes|Evernote]] ^b8cd50
- <span class="icon-app icon-apple-notes"></span> [[استيراد من Apple Journal|Apple Notes]]
...
- <span class="icon-app icon-html"></span> [[الإعدادات|ملفات HTML]]
- <span class="icon-app icon-md"></span> [[استيراد من Roam Research|ملفات Zettelkasten]]
- <span class="icon-app icon-md"></span> [[استيراد ملفات HTML|ملفات Markdown]]
