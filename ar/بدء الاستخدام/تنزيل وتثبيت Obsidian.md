...
1. افتح المتصفح وانتقل إلى [تنزيل Obsidian](https://obsidian.md/ar/download).
...
يمكنك اختياريًا تنزيل ملف APK لنظام Android من صفحة [تنزيل Obsidian](https://obsidian.md/ar/download).
