...
aliases:
  - Obsidian for teams
---
يمكن استخدام Obsidian كتطبيق لتدوين الملاحظات للأفراد، وكأداة تعاون لفريقك.

## استخدام Obsidian مع فريقك

- [[الترخيص التجاري|ترخيص تجاري]]
	- ادعم Obsidian عن طريق شراء ترخيص تجاري.
- [[نشر Obsidian عبر فريقك|نشر Obsidian عبر فريقك]]
	- كيفية تثبيت Obsidian وتحديثه وتخصيصه عبر فريقك.
- [[المزامنة للفِرق|المزامنة للفرق]]
	- كيفية مزامنة البيانات عبر فريقك.
- [[النشر للفِرق|النشر للفرق]]
	- كيفية نشر البيانات من خزنة فريقك.
