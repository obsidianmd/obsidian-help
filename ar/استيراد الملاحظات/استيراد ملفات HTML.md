...
يتيح لك Obsidian بسهولة استيراد ملفات HTML فردية ومجلدات كاملة من ملفات HTML باستخدام مكوّن [[المستورد]] الإضافي الرسمي. يمكن استخدام هذا إذا كنت ترغب في حفظ مواقع ويب كاملة بتنسيق [[Obsidian Flavored Markdown|Markdown]]، أو إذا كنت ترغب في استيراد بيانات من أداة تصدر إلى تنسيق HTML.
