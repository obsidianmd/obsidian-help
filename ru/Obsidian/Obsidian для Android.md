...
---
Мобильное приложение Obsidian для Android предоставляет мощные возможности ведения заметок на вашем устройстве Android. Вы можете загрузить его из [Google Play](https://play.google.com/store/apps/details?id=md.obsidian) или в виде [APK-файла](https://obsidian.md/ru/download).
