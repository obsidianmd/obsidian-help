...
6. В поле **API token** нажмите **Link...**, чтобы добавить новый секрет. В поле **ID** укажите имя, например `notion`, а в поле **Secret** вставьте ваш **Internal Integration Secret** из Notion.
