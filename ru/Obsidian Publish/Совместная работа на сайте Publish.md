...
publish: true
mobile: true
description: Узнайте, как совместно работать с другими пользователями Obsidian на вашем сайте Obsidian Publish.
aliases:
...
Только владельцу сайта необходима активная подписка на Obsidian Publish. Соавторам нужен лишь [аккаунт Obsidian](https://obsidian.md/ru/account).
