...
На настольных устройствах [примечания к выпуску](https://obsidian.md/ru/changelog/) Obsidian сообщат вам, когда необходимо обновить версию установщика Obsidian для корректной работы. Это версия Electron — фреймворка, на котором построен Obsidian, — и она не может быть обновлена в процессе автоматического обновления.
...
1. Перейдите по адресу https://obsidian.md/ru/download.
