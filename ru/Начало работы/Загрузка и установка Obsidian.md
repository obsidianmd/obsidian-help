...
1. Откройте браузер и перейдите на страницу [Загрузить Obsidian](https://obsidian.md/ru/download).
...
Вы также можете скачать APK-файл для Android со страницы [Загрузить Obsidian](https://obsidian.md/ru/download).
