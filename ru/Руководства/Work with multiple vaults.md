...
You can open another Vault anywhere on your computer, and it will retain its own individual [[Список плагинов|Plugins]] and [[Пользовательский CSS]]. This is useful, for example, if you have one Vault where you keep notes but a different one in which you do long-form writing.
