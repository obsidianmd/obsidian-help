...
Вы можете включить плагин Obsidian Sync в разделе **Настройки => Предустановленные плагины => Синхронизация**.
...
- Информацию о включенных [[Список плагинов|предустановленных плагинах]].
- Настройки предустановленных плагинов.
...
На данный момент каждое удаленное хранилище может содержать до 10 ГБ данных, включая историю версий.
...
- Используемая функция получения ключа: scrypt с salt
- Используемый алгоритм шифрования: AES-256 с GCM

##### Что означает ошибка с текстом «Размер хранилища превышает лимит»?

Максимальный размер каждого хранилища, использующего Obsidian Sync, составляет 10 Гб. Эта ошибка указывает на то, что размер вашего хранилища превысил этот лимит. Не забывайте, что вложения и история версий учитываются при измерении объема хранилища. Поэтому вы можете превысить лимит в 10 Гб, даже если фактический размер вашего хранилища меньше 10 Гб. 

Если вы видите эту ошибку, Obsidian может помочь вам определить большие файлы и очистить хранилище от них. Это можно сделать в разделе **Настройки => Синхронизация => Размер хранилища превышает лимит**.