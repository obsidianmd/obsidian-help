...
Действие `unique` создаёт новую уникальную заметку в хранилище. Плагин [[Плагины/Создатель уникальных заметок|Создатель уникальных заметок]] должен быть включён.
