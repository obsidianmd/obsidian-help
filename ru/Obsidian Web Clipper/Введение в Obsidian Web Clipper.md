...
Obsidian Web Clipper сохраняет контент локально в ваше хранилище Obsidian и следует нашей [политике конфиденциальности](https://obsidian.md/ru/privacy). Ваши данные не собираются, и мы не отслеживаем никаких метрик использования. Код является [открытым](https://github.com/obsidianmd/obsidian-clipper) и доступен для аудита.
