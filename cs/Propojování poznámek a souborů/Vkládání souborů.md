...
cssclasses:
  - soft-embed
---
Vložené soubory zobrazují svůj obsah přímo v poznámce a zůstávají aktuální, když se zdrojový soubor změní.
...
Můžete také vkládat konkrétní [[Interní odkazy#Odkaz na nadpis v poznámce|nadpisy]] a [[Interní odkazy#Odkaz na blok v poznámce|bloky]].
...
Pokud zadáte pouze šířku, obrázek se škáluje proporcionálně. Například `![[Engelbart.jpg|100]]`.

![[Engelbart.jpg#outline|100]]

Můžete také vložit externě hostovaný obrázek pomocí Markdown odkazu. Šířku a výšku můžete ovládat stejnou syntaxí jako u wiki odkazu.
...
> [!info]+ Embedy Plátna zobrazují pouze tvary
> Vložená Plátna zobrazují tvary, ale ne text uvnitř karet. Pro zobrazení celého Plátna jej otevřete přímo.
