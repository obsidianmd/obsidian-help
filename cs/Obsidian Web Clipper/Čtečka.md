...
Čtečka extrahuje hlavní obsah ze stránky. Původní stránka je nahrazena čistým zobrazením pro čtení, které zahrnuje:

- Název článku, autora, datum publikace a zdrojovou doménu.
- Hlavní obsah článku se zachovanými obrázky a formátováním.
- Osnovu v postranním panelu pro články s více nadpisy.
- Zvýraznění syntaxe pro bloky kódu.
- Vyskakovací okna poznámek pod čarou, která se po kliknutí zobrazí přímo v textu.
