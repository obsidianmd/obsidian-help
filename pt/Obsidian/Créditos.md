...
permalink: credits
---
Os nomes não estão listados por quantidade de contribuição, mas alfabeticamente (ou pelo menos tentamos!).

## Equipa principal

A equipa principal que constrói e mantém o Obsidian.
...
Programadores a tempo parcial que ajudam a construir o Obsidian.
...
Os moderadores gerem o Fórum, Discord e Reddit do Obsidian.
...
Antigos moderadores e membros da equipa que partiram para novas aventuras!
...
Créditos a estes programadores de plugins por terem sido pioneiros em funcionalidades que foram adaptadas para o Obsidian:
...
- jstone por manter as nossas compilações no Flathub
- adamgibbins e ran-dall por manterem as nossas compilações no homebrew

## Tradutores

Veja também a lista completa de [contribuidores de tradução](https://github.com/obsidianmd/obsidian-translations/graphs/contributors?from=7%2F31%2F2020).

- Andrea Brandi (Italiano)
- Anne-Katrin aka Mephi (Alemão)
- bongudth (Vietnamita)
- canzi-teacher, 蚕子 (Chinês Simplificado)
- cor-bee, Ілля Пишняк (Ucraniano)
- cvyl, Mikka (Neerlandês)
- Daniel Mathiot (Francês)
- Diego Tres (Português do Brasil)
- Haitham Mohamed (Árabe)
- Henrik Falk (Dinamarquês)
- Joffrey Schroeder (Francês) 
- JxhnnyUt8h (Russo)
...
- Solyta Teng (Khmer)
- taksas, 中山 拓海 (Japonês)
- VKondakoff, Валерий Кондаков (Russo)
- yo-goto, ぱだわん (Japonês)
- Zachary Shirmohammadli (Persa) 

## Organizações apoiantes

As organizações que apoiam o Obsidian com uma [[Licença comercial]] estão destacadas na nossa página [Enterprise](https://obsidian.md/enterprise/). 

## Documentação

A primeira versão do cofre de ajuda foi escrita por Silver. Posteriormente, parte foi escrita por [@mediapathic](http://mediapathic.net), com grande ajuda do Reggie. Também recebemos correções dos muitos olhos atentos na comunidade do Discord e do fórum.

A documentação foi mantida por [Marcus Olsson](https://marcus.se.net/) durante algum tempo. Atualmente é mantida pela equipa do Obsidian.

Agora aceitamos pull requests para o cofre de ajuda no [nosso repositório de documentação](https://github.com/obsidianmd/obsidian-docs/). Issues são bem-vindos.

### Adicione o seu nome

Se é tradutor, por favor faça um pull request para adicionar "O Seu Nome (idioma contribuído)" à secção acima. Por favor mantenha a lista de nomes em ordem alfabética, obrigado!

Se o seu nome não está em inglês e não pode ser listado alfabeticamente, use este formato: `o-seu-nome-de-utilizador-github, [o seu nome no seu idioma] (Nome do idioma)`.

## Reconhecimentos de terceiros

O Obsidian utiliza as seguintes bibliotecas de código aberto (por ordem alfabética):
...
Licenciado sob a [Licença Pública Mozilla versão 2.0](http://mozilla.org/MPL/2.0/)
...
O logótipo do Obsidian utilizado antes da v1.3.5 foi adaptado de:
