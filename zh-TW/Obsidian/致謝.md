...
參與[社群](https://community.obsidian.md/)外掛/主題審查流程與工具的貢獻者。
...
版主管理 Obsidian 論壇、Discord 與 Reddit。
...
另請參閱完整的[翻譯貢獻者](https://github.com/obsidianmd/obsidian-translations/graphs/contributors?from=7%2F31%2F2020)清單。
...
以[[商業授權]]支持 Obsidian 的組織刊登在我們的 [Enterprise](https://obsidian.md/enterprise/) 頁面。
