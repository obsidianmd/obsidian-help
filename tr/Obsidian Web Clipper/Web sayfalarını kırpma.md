...
| Vurgulayıcı modunu aç/kapat | `Opt+Shift+H`  | `Alt+Shift+H`   |
...
- Web Kırpıcı ayarlarında eklenen kayıtlı [[Obsidian Web Clipper/Şablonlar|şablonlarınız]] arasında geçiş yapmak için **Şablon** açılır menüsü.
- Şablonlarda kullanabileceğiniz sayfa değişkenlerini görüntülemek için **Daha fazla (...)** düğmesi.
- [[Web sayfalarını vurgulama|Vurgulamayı]] açmak için **Vurgulayıcı** düğmesi.
- Web Kırpıcı ayarlarını açmak için **Dişli** düğmesi.
