...
- Herhangi bir [[Highlighter|vurgulama]] mevcutsa vurgulamaları kullanır.
...
1. **Üst bilgi** şablonları değiştirebileceğiniz, [[Highlighter|vurgulamayı]], [[Okuyucu|okuma modunu]] açabileceğiniz ve ayarlara erişebileceğiniz bölüm.
...
- ![[lucide-highlighter.svg#icon]] [[Highlighter|Vurgulamayı]] açmak için **Vurgulayıcı** düğmesi.
...
- Sayfada [[Interpreter|doğal dil istemlerini]] çalıştırmak için **Yorumlayıcı**.
