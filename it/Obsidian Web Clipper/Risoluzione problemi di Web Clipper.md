...
- Se usi Flatpak, potresti dover aggiornare il valore `x-scheme-handler/obsidian` presente nel file `.config/mimeapps.list` da `obsidian.desktop` a `md.obsidian.Obsidian.desktop`.
