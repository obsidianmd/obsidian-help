...
> I dispositivi mobile e i tablet hanno accesso limitato alle loro console per sviluppatori. Per questi utenti, consigliamo di utilizzare il plugin della community [Logstravaganza](https://community.obsidian.md/plugins/logstravaganza) per generare automaticamente i dati del log della console in una nota Markdown.
