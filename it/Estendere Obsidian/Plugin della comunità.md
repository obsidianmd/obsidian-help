...
mobile: false
description: Scopri come estendere Obsidian con plugin creati dalla community.
aliases:
  - Community plugins
---
...
Puoi anche sfogliare i plugin disponibili nel tuo browser, andando su [community.obsidian.md](https://community.obsidian.md). Per maggiori informazioni su cosa mostra la pagina di un plugin, consulta [[Directory della comunità]].
...
Per utilizzare un plugin installato, devi abilitarlo.
...
Per motivi di sicurezza, i plugin della community non si aggiornano automaticamente. Puoi aggiornare tutti i plugin contemporaneamente o aggiornare singoli plugin.
...
Pronto a creare il tuo plugin della community? Scopri come [Creare un plugin](https://docs.obsidian.md/Plugins/Getting+started/Build+a+plugin).
