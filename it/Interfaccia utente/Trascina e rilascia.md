...
aliases:
  - Drag and drop
---
Ci sono molti modi per trascinare e rilasciare elementi in Obsidian. Questo include schede, file, cartelle e contenuti.
...
- È possibile trascinare qualsiasi contenuto HTML dal browser in Obsidian per convertirlo automaticamente in Markdown.
- È possibile trascinare e rilasciare qualsiasi file dal proprio esplora file nativo affinché Obsidian importi (crei una copia di) quei file nella cartella degli allegati della cassaforte e li inserisca come collegamenti interni. Tenere premuto `Ctrl` su Windows/Linux o `Option` su macOS per creare collegamenti assoluti `file:///` a quei file invece di importare una copia.

### Rilasciare file all'esterno di Obsidian

- Questo crea un URL `obsidian://` nell'applicazione esterna per la nota di Obsidian che è stata trascinata.
