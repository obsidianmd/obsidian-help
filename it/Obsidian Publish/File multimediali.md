...
I PDF hanno dimensioni e complessità variabili. Per ottimizzare le prestazioni dei PDF incorporati in Publish, raccomandiamo di [comprimere i file](https://www.adobe.com/acrobat/hub/how-to-make-pdfs-smaller.html) e rimuovere le immagini non necessarie. La maggior parte degli editor PDF offre queste funzionalità.

## Video e audio

Publish non è ottimizzato per ospitare video, GIF o file audio di grandi dimensioni. Incorporare video ospitati internamente e collegati non è consigliato se prevedi di ospitare numerosi file di questo tipo.

Per ospitare un numero limitato di file, raccomandiamo di utilizzare i seguenti formati:

**Video**
- `.mp4`
- `.webm`
- `.hevc` o `.av1` _(Nota: non ampiamente supportati)_
