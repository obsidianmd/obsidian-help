...
---
Scopri come collaborare sul tuo sito [[Introduzione a Obsidian Publish|Obsidian Publish]] con altri utenti Obsidian. Aggiungendo amici e colleghi come collaboratori, potranno pubblicare modifiche sul tuo sito.
...
1. Nella [[Barra multifunzione|barra degli strumenti]], seleziona **Pubblica modifiche** ![[lucide-send.svg#icon]] oppure apri la [[Riquadro comandi|tavolozza dei comandi]] e digita **Publish: Pubblica modifiche**
...
> [!tip] Ti consigliamo di utilizzare un altro strumento per sincronizzare le modifiche tra le cassaforti, come [[Introduzione a Obsidian Sync|Obsidian Sync]] o [git](https://git-scm.com/).
