...
---
Obsidian semplifica la creazione e la modifica di wiki, basi di conoscenza, documentazione e altri tipi di siti web. Può essere utilizzato come strumento di editing o CMS sia per siti interni che esterni.
...
Obsidian Publish è progettato principalmente per elaborare file di testo normale e immagini di piccole dimensioni, presentandoli su un sito web per la visualizzazione. Obsidian Publish non è progettato per ospitare media di grandi dimensioni, come gallerie di immagini ad alta risoluzione e video. Per questo consigliamo di ospitare le tue risorse su un CDN dedicato.

### Domande frequenti

**Ogni dipendente deve acquistare un abbonamento Publish?**
No. Solo il proprietario del sito deve acquistare un abbonamento Obsidian Publish.
