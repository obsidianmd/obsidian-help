...
- ![[obsidian-icon-sync-disconnected.svg#icon]] **Disconnesso**: Il plugin principale Sync è attivo, ma la [[Vault locali e remoti|cassaforte locale]] non è connessa a un caveau remoto. Questa icona è tipicamente rossa.
...
- ![[lucide-cog.svg#icon]] [[Impostazioni sincronizzazione e sincronizzazione selettiva|Impostazioni sincronizzazione]]
...
> [!info] Questo messaggio può anche indicare altri potenziali problemi di Sync. Se lo vedi ripetutamente e ritieni che ci siano ancora elementi da sincronizzare, [[Aiuto e supporto#Contattare il supporto Obsidian|contatta il supporto Obsidian]].

**Fully synced**
- La cassaforte locale e il caveau remoto sono completamente sincronizzati.

**Merging conflicted file**
È stato rilevato un conflitto durante la sincronizzazione e il file è stato unito anziché sovrascritto. Consulta [[Risoluzione problemi di Obsidian Sync#Risoluzione dei conflitti|risoluzione dei conflitti]] per maggiori informazioni. Se l'unione non è desiderata, puoi ripristinare versioni precedenti tramite la [[Cronologia versioni]] o il [[Recupero file]].
...
In questi casi, dovrai [[Configurare Obsidian Sync#Disconnettersi da un caveau remoto|disconnetterti dal caveau remoto]] e [[Configurare Obsidian Sync#Creare un nuovo caveau remoto|creare un nuovo caveau remoto]], assicurandoti che i tuoi dati locali siano preservati.
...
In alcuni casi, un plugin della community può anche impedire a Obsidian Sync di confermare lo stato di accesso del tuo account. Entra in **[[Sicurezza dei plugin#Modalità con restrizioni|Modalità con restrizioni]]** e riprova.
