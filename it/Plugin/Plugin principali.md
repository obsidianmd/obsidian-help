...
Alcuni plugin principali sono disabilitati per impostazione predefinita. Puoi abilitarli in **[[Impostazioni|Impostazioni]] → Plugin principali**.
...
> Se non riesci a trovare il plugin che stai cercando qui, dai un'occhiata ad alcuni dei [[Plugin della comunità|plugin creati dalla community]]. Puoi anche [Creare un plugin](https://docs.obsidian.md/Plugins/Getting+started/Build+a+plugin) tu stesso.
