...
I collegamenti esterni si aprono come [[Tabs|schede]] che puoi riorganizzare, dividere e aprire in una [[pop-out windows|finestra esterna]]. Qualsiasi scheda di pagine web incorporata nei file [[Canvas]] può essere aperta come scheda del visualizzatore web.
...
Fai clic sull'icona altre azioni per salvare una pagina web nella tua cassaforte. Puoi personalizzare la posizione di salvataggio della pagina andando su **[[Settings|Impostazioni]]** → **Visualizzatore web**.
