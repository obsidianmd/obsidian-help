...
- Utilizzare il menu contestuale per accedere a tutte le operazioni disponibili.
...
1. Fare clic con il tasto destro sulla cartella e poi fare clic su **Nuova nota**.
2. Digitare il nome della nota e premere Invio.
...
1. Fare clic con il tasto destro sulla cartella in cui si desidera creare la sottocartella, quindi fare clic su **Nuova cartella**.
2. Digitare il nome della cartella e premere Invio.
