...
1. Nella [[Tavolozza dei comandi|tavolozza dei comandi]], seleziona **Apri importazione Markdown**. È possibile accedervi anche dalla [[Ribbon|barra degli strumenti]] con l'icona **Apri importazione Markdown** ( ![[lucide-binary.svg#icon]] ).
