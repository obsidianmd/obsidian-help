...
## Estensione del foglio di condivisione

Obsidian offre un'estensione del foglio di condivisione che puoi utilizzare in altre app per inviare collegamenti, testo, immagini o documenti alla tua cassaforte di Obsidian.

Per condividere un collegamento da Safari:

1. Apri la pagina web in Safari, quindi tocca il pulsante **Condividi**.
2. Nel menu di condivisione, scorri verso sinistra nella riga delle app, tocca **Altro**, quindi tocca **Modifica**.
3. Attiva **Obsidian** in modo che appaia nel menu di condivisione.
4. Tocca il pulsante **Aggiungi** accanto a Obsidian per aggiungerlo ai **Preferiti**.
5. (Opzionale) Trascina il pulsante **Riordina** accanto a Obsidian per cambiarne la posizione nei Preferiti.
6. Tocca **Fatto**.
7. Tornando al menu di condivisione di Safari, tocca **Obsidian**.
8. Quando tocchi Obsidian, appare il foglio di condivisione di Obsidian che ti permette di condividere il contenuto selezionato nella tua cassaforte.
