Une fois que vous avez installé l'extension navigateur du web clipper, vous pouvez y accéder de différentes façons en fonction du navigateur que vous utilisez :
...
2. **Propriétés :** c'est là où se trouvent les métadonnées extraites de la page qui sera sauvegardée dans Obsidian ; 
...
- **Liste déroulante de templates** pour passer d'une template à une autre ;
- **Fonctionnalité "Plus" (...)** pour activer le surlignage ; 
- **Bouton roue dentée** pour ouvrir les paramètres du Web clipper. 
 ...
 - **Résumer la page** pour prompter des actions sur la page en langage naturel, comme avec une IA.