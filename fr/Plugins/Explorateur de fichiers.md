...
- Utiliser le menu contextuel pour accéder à toutes les opérations disponibles.
...
1. Faites un clic droit sur le dossier puis cliquez sur **Nouvelle note**.
2. Tapez le nom de la note, puis appuyez sur Entrée.
...
1. Faites un clic droit sur le dossier dans lequel vous souhaitez créer le sous-dossier, puis cliquez sur **Nouveau dossier**.
2. Tapez le nom du dossier, puis appuyez sur Entrée.
...
1. Faites un clic droit sur le fichier que vous souhaitez supprimer, puis cliquez sur **Supprimer**.
2. Si une confirmation de suppression vous est demandée, cliquez sur **Supprimer**.

Pour plus d'informations, consultez [[Gérer les notes#Supprimer une note|Supprimer une note]].

## Renommer un fichier ou un dossier

1. Faites un clic droit sur le fichier que vous souhaitez renommer, puis cliquez sur **Renommer**.
