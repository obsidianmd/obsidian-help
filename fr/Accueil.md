...
1. [[Télécharger et installer Obsidian|Télécharger et installer Obsidian]]
2. [[Créer un coffre|Créer un coffre]]
3. [[Créer votre première note|Créer votre première note]]
4. [[Lier des notes|Lier des notes]]
5. [[Importer des notes|Importer des notes]]
6. [[Synchroniser vos notes entre appareils|Synchroniser vos notes sur tous vos appareils]]
...
Si vous souhaitez contribuer financièrement à Obsidian, envisagez une [[Licence Catalyst|licence Catalyst]] qui offre un accès anticipé aux versions bêta, ou une [[Licence commerciale|licence commerciale]] pour témoigner du soutien de votre organisation.

Consultez les [[Crédits|Crédits]] pour découvrir toutes les personnes formidables qui rendent Obsidian possible.
