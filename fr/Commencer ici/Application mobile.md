...
L'icône centrale en forme de plus dans un cercle vous permet de créer une nouvelle note ou de basculer vers une note existante. Cela équivaut à ouvrir le [[Sélecteur rapide]].
...
Pour des informations détaillées sur le fonctionnement des barres latérales sur mobile, consultez [[Barre latérale#Ouvrir les barres latérales masquées#Mobile et petites tablettes|Ouvrir les barres latérales sur mobile]].
