...
Obsidian sur les appareils de bureau vérifie régulièrement la présence de nouvelles mises à jour. Si les mises à jour automatiques sont activées, l'application se mettra à jour au redémarrage. Obsidian nécessite des [[#Mises à jour du programme d'installation|mises à jour du programme d'installation]] périodiques, qui requièrent de télécharger et d'exécuter le programme d'installation.

Sur les appareils mobiles, Obsidian est mis à jour via le magasin d'applications de l'appareil. La version du programme d'installation est la même que la version de l'application. Obsidian ne dispose pas de mise à jour automatique.

## Vérifier les mises à jour et afficher la version
...
Pour vérifier les mises à jour, sélectionnez **Vérifier les mises à jour**. Si de nouvelles mises à jour sont disponibles, Obsidian proposera de relancer l'application. Sélectionnez **Relancer** pour appliquer les mises à jour disponibles.
