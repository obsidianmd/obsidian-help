...
Les volets peuvent être liés manuellement les uns aux autres en utilisant le menu **Plus d'options** (![[symbole-plus-d'options]]). Vous pouvez également, depuis le menu **Plus d'options**, ouvrir les rétroliens d'un volet spécifique, ce qui ne sera lié qu'à ce fichier. Il y a une option équivalente dans la [[palette de commandes]].
