...
- L'activation des plugins fait apparaître leurs paramètres dans la liste des onglets. Par exemple, lorsque vous activez "**CSS personnalisé**", un onglet "**Thèmes communautaires**" apparaît, celui-ci permet de sélectionner un **[[Thèmes CSS|thème CSS personnalisé]]** afin de modifier l'apparence visuelle de l'interface d'Obsidian.
