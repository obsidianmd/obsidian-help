...
Comme vous pouvez le voir lorsque vous ouvrez la note dans votre coffre Obsidian, la syntaxe est cachée même si elle est bien présente. Pour la rendre visible il suffit de mettre le curseur sur la même ligne que la syntaxe. 
