...
Pour basculer entre les modes aperçu et édition, cliquez sur le bouton **Aperçu** dans la barre de titre, à droite. En mode édition, il apparaîtra comme une page ; en mode aperçu, comme un crayon. Si vous cliquez sur `Cmd / Ctrl`-, l'aperçu sera ouvert dans un [[Volet lié]]. Vous pouvez également basculer vers le mode aperçu en appuyant sur `Cmd / Ctrl-E`, mais vous pouvez bien sûr modifier ce  [[Raccourcis clavier|racourci clavier]].
