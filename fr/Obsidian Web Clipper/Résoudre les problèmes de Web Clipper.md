...
- Si vous utilisez le Flatpak, vous devrez peut-être mettre à jour la valeur `x-scheme-handler/obsidian` trouvée dans votre `.config/mimeapps.list` de `obsidian.desktop` à `md.obsidian.Obsidian.desktop`.
