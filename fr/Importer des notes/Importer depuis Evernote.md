...
---
Obsidian vous permet de migrer facilement vos notes depuis Evernote en utilisant le [[Importateur|module Importer]]. Celui-ci convertira vos données Evernote en fichiers Markdown durables, que vous pourrez utiliser avec Obsidian et de nombreuses autres applications.
