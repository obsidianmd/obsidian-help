...
cssclasses:
  - soft-embed
---
Obsidian vous permet de migrer vos notes depuis Craft. Cela convertit vos données Craft en fichiers Markdown durables que vous pouvez utiliser avec Obsidian et de nombreuses autres applications.
