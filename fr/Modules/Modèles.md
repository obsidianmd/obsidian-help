...
Vous pouvez modifier les formats de date et d'heure par défaut sous **[[Paramètres]] → Modèles → Format de date** et **[[Paramètres]] → Modèles → Format d'heure**. ^template-settings-date-time-formatting
