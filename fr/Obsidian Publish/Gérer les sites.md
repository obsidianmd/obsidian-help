...
aliases:
  - Manage sites
---
This page explains how to manage [[Introduction à Obsidian Publish|Obsidian Publish]] sites.

A site is a collection of notes that's hosted by Obsidian Publish and available online, either through a Obsidian Publish address or a [[Domaines personnalisés|custom domain]].
...
| Logo                            | Input  | The image you want to act as your site banner. The image must [[Publier votre contenu#Publish notes\|be published]]. |
...
| Custom Domain                   | Button | [[Domaines personnalisés]]                                                                                                         |
...
| Stack Pages          | Toggle | Enable or disable [[Onglets#Stack tab groups\|Stacked tabs]] on your site.    |

### Components

| Option                 | Type   | Description                                                                                                                          |
|------------------------|--------|--------------------------------------------------------------------------------------------------------------------------------------|
| Show navigation        | Toggle | Enable or disable the [[Explorateur de fichiers]] view on your publish site.                                                                   |
| Customize navigation   | Button | [[Personnaliser votre site#Customize navigation\|Customize]] the order of how your files are listed if **Show navigation** is toggled on. |
...
| Show backlinks         | Toggle | Enable or disable [[Liens retour]] on your site.                                                                                        |

### Other site settings

| Option                         | Type   | Description                                            |
| ------------------------------ | ------ | ------------------------------------------------------ |
| Passwords                      | Button | [[Obsidian Publish/Sécurité et confidentialité#Add a site password\|Set a password]] to restrict access to your entire site. |
