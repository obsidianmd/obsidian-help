...
Aby zaktualizować wszystkie łącza `[[UID]]` w swoim sejfie, tak aby używały pełnej nazwy notatki, użyj [[Konwerter formatowania|Konwertera formatowania]].
...
5. Wybierz **Rozpocznij konwertowanie**. Spowoduje to konwersję wszystkich notatek w całym sejfie.
