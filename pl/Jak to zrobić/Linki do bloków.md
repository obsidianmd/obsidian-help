In Obsidian 0.9.5 or higher, in addition to [[Link wewnętrzny#Link to headings|linking to headings]], you can also link to blocks.
...
Similar to [[Wstawianie plików|files embeds]], you can simply use `!` in front of a block link to embed it.
