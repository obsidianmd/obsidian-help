...
> 5. Use our [[Konwerter formatu Markdown]] to convert Roam Research's Markdown format into Obsidian's format.
...
If you're importing from Bear, the [[Konwerter formatu Markdown]] plugin has an option to convert `::highlight::` to `==highlight==`.
...
In order to fix that, you can use our [[Konwerter formatu Markdown]] to convert your Zettelkasten links into either `[[202001010000 My Note]]` or `[[202001010000 My Note|My Note]]`.

You might also be interested in the [[Automatyczne tworzenie prefiksów Zettelkasten]] plugin.
