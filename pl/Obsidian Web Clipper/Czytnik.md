...
Czytnik wyodrębnia główną treść ze strony. Oryginalna strona zostaje zastąpiona czystym widokiem czytania, który zawiera:

- Tytuł artykułu, autora, datę publikacji i domenę źródłową.
- Główną treść artykułu z zachowanymi obrazami i formatowaniem.
- Konspekt na panelu bocznym dla artykułów z wieloma nagłówkami.
- Podświetlanie składni dla bloków kodu.
- Wyskakujące okienka przypisów wyświetlane w tekście po kliknięciu.
