...
publish: true
mobile: true
description: 'Ta strona zawiera listę podstawowych wtyczek instalowanych wraz z Obsidian oraz wtyczek społecznościowych, które również są przez nich utrzymywane.'
---
Ta strona zawiera listę wbudowanych wtyczek dostarczanych wraz z Obsidian. Wbudowane wtyczki są oficjalnie tworzone i wspierane przez zespół Obsidian i są częścią aplikacji.

Niektóre wbudowane wtyczki są domyślnie wyłączone. Możesz je włączyć w **[[Ustawienia]] → Wbudowane wtyczki**.

Zespół Obsidian zajmuje się również rozwojem niektórych [[#Inne wtyczki|wtyczek społeczności o otwartym kodzie źródłowym]].

> [!tip] Wtyczki społeczności
> Jeśli nie możesz znaleźć szukanej wtyczki, sprawdź [[Wtyczki społeczności|wtyczki stworzone przez społeczność]]. Możesz także [stworzyć własną wtyczkę](https://docs.obsidian.md/Plugins/Getting+started/Build+a+plugin).
...
Zespół Obsidian utrzymuje również wtyczki dostępne w sklepie wtyczek społeczności:
