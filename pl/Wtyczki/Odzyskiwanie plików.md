...
Migawki są przechowywane w [[Jak Obsidian przechowuje dane#Ustawienia globalne|ustawieniach globalnych]], poza sejfem, aby zabezpieczyć się przed utratą danych związaną ze sejfem. Oznacza to, że migawki są zapisywane z bezwzględną ścieżką do notatki. Jeśli niedawno przeniosłeś swój sejf, może być konieczne przeniesienie go z powrotem do lokalizacji, w której znajdował się w momencie tworzenia migawki.
...
1. Otwórz **[[Ustawienia]]**.
2. Na panelu bocznym wybierz **Odzyskiwanie plików** w sekcji **Wbudowane wtyczki**.
...
> [!danger] Wyczyszczenie historii migawek nieodwracalnie usuwa wszystkie migawki w Twoim sejfie.
...
- **Lokalizacja sejfu**: Jeśli przeniesiesz sejf do innej lokalizacji bez użycia [[Zarządzaj sejfami#Przenoszenie sejfu do innego folderu|przełącznika sejfów]], istniejące migawki mogą być niedostępne.
