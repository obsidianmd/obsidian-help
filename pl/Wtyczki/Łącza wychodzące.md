...
publish: true
mobile: false
description: 'Linki wychodzące to podstawowa wtyczka, która pokazuje w skrócie linki prowadzące z aktywnej notatki, a także potencjalne linki, które można utworzyć.'
---
...
Aby stworzyć łącze z niepowiązanej wzmianki, kliknij przycisk z nazwą notatki.

> [!tip] Wskazówka
> Niepowiązane wzmianki mogą odnosić się do różnych notatek o tej samej nazwie. Aby wyświetlić pełną ścieżkę notatki, najedź kursorem na przycisk z nazwą notatki.

> [!note] Bloki kodu
> Chociaż możesz utworzyć łącze z niepowiązanej wzmianki wewnątrz bloku kodu, ze względu na naturę bloków kodu, łącza nie są wyświetlane w sekcji Łącza.
