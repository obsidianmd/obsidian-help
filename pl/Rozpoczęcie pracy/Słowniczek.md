...
permalink: glossary
---
Ten słowniczek zawiera powszechnie stosowaną terminologię Obsidian.
...
**Polecenie** to akcja, którą można wykonać, wybierając ją z [[Lista poleceń|palety poleceń]] lub przypisując do [[#Skrót klawiszowy|skrótu klawiszowego]].

## Osadzanie

**Osadzanie** oznacza zastąpienie odniesienia do zewnętrznej zawartości samą zawartością, na przykład w celu dołączenia obrazu do notatki. Zobacz także [[Osadzanie plików]].
...
**Graf** to wizualizacja przedstawiająca powiązania między [[#Notatka|notatkami]]. Zobacz także [[Podgląd grafu]].

## Skrót klawiszowy

**Skrót klawiszowy** to skrót klawiaturowy dla [[#Polecenie|polecenia]]. Zobacz także [[Skróty klawiszowe]] i [[Skróty klawiszowe|Jak/Używać skrótów klawiszowych]].
...
**Obszar główny** to centralna część aplikacji Obsidian, w której przede wszystkim edytujesz [[#Notatka|notatki]].

## Markdown

Markdown to język znaczników do formatowania tekstu i główny format plików używany do notatek w Obsidian — pliki `.md`. Zobacz także [[Podstawowa składnia formatowania]].
...
**Wtyczka** rozszerza Obsidian o dodatkowe funkcje.

- [[Wbudowane wtyczki]] są tworzone przez zespół Obsidian i domyślnie dołączone.
- [[Wtyczki społeczności]] są tworzone przez zewnętrznych deweloperów wtyczek i wymagają [[Wtyczki społeczności#Instalacja wtyczki społeczności|zainstalowania]] przed użyciem.

Możesz [stworzyć własną wtyczkę](https://docs.obsidian.md/Plugins/Getting+started/Build+a+plugin).
...
**Wstążka** służy jako kontener na często używane ikony akcji.

W wersji desktopowej jest to pionowy obszar znajdujący się po lewej stronie.
...
**Fragment**, czyli [[Snippety CSS|fragment CSS]], zmienia wygląd Obsidian, podobnie jak [[#Motyw|motyw]]. W przeciwieństwie do motywów, można jednocześnie stosować wiele fragmentów.

## Pasek stanu

**Pasek stanu** w aplikacji Obsidian wyświetla istotne statystyki i stany. W wersji desktopowej znajdziesz go w prawym dolnym rogu, natomiast na urządzeniach mobilnych jest umieszczony na dole aplikacji.
...
**Grupa kart** to zbiór [[#Karta|kart]] w [[#Obszar główny|obszarze głównym]]. Karty w grupie kart mogą być układane w stos.

## Tag

**Tag** to słowo zaczynające się od znaku hash (`#`), na przykład `#book`. Tagi służą przede wszystkim do znajdowania powiązanych [[#Notatka|notatek]].
