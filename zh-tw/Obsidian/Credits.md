...
- jstone 在 flathub 上維護組建
- adamgibbins and ran-dall 在 homebrew 維護組建

### 說明檔案

第一版的說明檔案由 Silver 編寫，之後則由 [@mediapathic](http://mediapathic.net) 接手，以及 Reggie 的鼎力相助。同時 Discord 伺服器和論壇的使用者也幫助我們修正錯誤。

我們現在接受說明庫的 pull request，前往 [Github 儲存庫](https://github.com/obsidianmd/obsidian-docs/)。

##### 加入您的大名

如果您是譯者，請開立一個 pull request 以將 "您的名字 (語言名稱)" 加入上方的欄位，並以字母排序。謝謝！

如果您的名字不是英文，無法依字母排序，請使用此格式：`您的 Github 使用者名稱, [您的名字 (以您的語言)] (語言名稱)`。
