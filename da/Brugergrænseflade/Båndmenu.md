...
## Tilpasning af båndmenuen

Dine tilpasninger af båndmenuen huskes over sessioner og synkroniseres med andre enheder og på mobil appen, når app indstillinger, specifikt `workspace.json` filen, bliver synkroniseret.


### På desktop

I desktop versionen kan du tilpasse båndmenuen sådan:

- Flyt rundt på rækkefølgen af båndmenu handlingerne ved at trække og slippe ikonerne i den rækkefølge du ønsker dem
- For at skjule specifikke handlinger kan du højreklikke på et ledigt område i båndmenuen og fjerne markeringen på den handling, som du vil skjule
...
Hurtig tilgang funktionen er som standard sat til "Åben båndmenu" med et *kort tryk*.
Hvis du vælger en anden måde som hurtig tilgang:

- Vil den valgte mulighed blive udløst af et *kort tryk*
- Tilgangen til båndmenuen vil ændre sig til et *langt tryk*

> [!info] Mulighederne for hurtig tilgang afhænger af indstillingerne i Obsidian og de kerneplugins du har aktiveret.
