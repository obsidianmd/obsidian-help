...
Her er en liste af ændringstaster du kan benytte for at åbne links på forskellige måder:

|Aktion|MacOS|Windows/Linux|
|---|---|---|
|**Naviger**|_Ingen_|_Ingen_|
|**Ny fane**|`⌘` (+ `Shift` i kildetilstand)|`Ctrl` (+ `Shift` i kildetilstand)|
|**Ny fanegruppe**|`⌘` `⌥`| `Ctrl` `Alt`|
|**Nyt vindue**|`⌘` `⌥` `Shift`|`Ctrl` `Alt` `Shift`|


## Organiser dine faner og vinduer

Alle faner tilhører en _fanegruppe_. Du kan omarrangere faner i en fanegruppe ved at trække og slippe dem, flyte faner til en anden fanegruppe, eller oprette en ny fanegruppe. Du kan trække faner ud af deres vindue på desktop versionen af Obsidian for at åbne dem i et separat [[Pop-op vinduer|popup vindue]].
...
Træk en fane langs de åbne faner i fanegruppen for at ændre rækkefølgen af dine faner.
...
Højreklik på en fane og vælg **Split til højre** eller **Split ned** for at oprette en ny fanegruppe med den valgte fane.

Du kan også splitte en fanegruppe ved at trække fanen til bunden af en anden fane.

### Skaler en fanegruppe

For at skalere en fanegruppe skal du føre musemarkøren ud over kanten af en fanegruppe. Kanten af fanegruppen bliver fremhævet, når man kan trække i den for at skalere.

Du kan skalere sidepanelerne på samme måde for at få mere plads til fanegrupper in midten.
...
| Skift til                 | MacOS            | Windows/Linux        |
|---------------------------|------------------|----------------------|
| **Næste fane**              | `⌃`+`⇥`         | `Ctrl`+`Tab`         |
| **Forrige fane**          | `⌃`+`⇧`+`⇥`    | `Ctrl`+`Shift`+`Tab` |
| **Første fane til vendtre** | `⌘`+`1`          | `Ctrl`+`1`           |
| **2 til 8 fane**        | `⌘`+`2`..`8`     | `Ctrl`+`2`..`8`      |
| **Sidste fane til højre** | `⌘`+`9`          | `Ctrl`+`9`           |
| **Sidst lukkede fane**   | `⌘`+`⇧`+`t`     | `Ctrl`+`Shift`+`t`   |
...
Fanegruppering er inspireret af [Andy Matushak's sliding notes](https://notes.andymatuschak.org/).
...
1. Klikke på **Flere muligheder** i øverste højre hjørne af noten eller højreklikke på en fanetitel
2. Under **Åbn linket visning** i popupmenuen og skal du vælge den visning du ønsker at åbne
