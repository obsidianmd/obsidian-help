...
mobile: true
aliases:
  - Publicer og håndter udgivelser af noter
  - Obsidian Publish/Publicer og håndter udgivelser af noter
---
Denne side forklarer, hvordan du adminnistrerer dine udgivne noter.
...
Du kan vælge noter, som automatisk skal udgives ved at sætte `publish: true` i notens [[Egenskaber|metadata]] sektion.

## Ignorer noter til udgivelse

Du kan ignorere noter, som skal ved at sætte `publish: false` i notens [[Egenskaber|metadata]] sektion.
