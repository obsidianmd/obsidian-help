...
Når formlen er oprettet, kan du anvende formel egenskaben på samme måde som andre egenskaber i din base. Tilføj den til [[Visninger|views]], brug den i filtre, sortér med den, og mere.
