...
aliases:
  - baser/views/tabel
  - Tabel view
  - Baser/Layouts/Tabel view
---
Tabeller er en [[Visninger|viewtype]], som du kan anvende i [[Introduktion til Baser|Baser]].
...
INdstillingerne for tabelviews kan konfigureres i [[Visninger#View indstillinger|View indstillingerne]].
...
Summeringen vises i bunden af kolonnen. Når resultater er [[Visninger#Sådan sorterer og grupperer du resultater|grupperet]], vil summeringen for hver gruppe vises i toppen af gruppen.
...
3. Angiv en formel. Formlen benyttes på hele listen af værdier i den kolonne (fx.  [[Funktioner|funktioner]] som `værdier.reduce(...)`)
4. Gem summeringen
