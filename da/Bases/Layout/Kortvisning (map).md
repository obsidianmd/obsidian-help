...
aliases:
  - baser/views/landkort
  - Landkort view
  - Baser/Layouts/Landkort view
---
Landkort er en [[Visninger|viewtype]], som du kan anvende i [[Introduktion til Baser|Baser]]. Det kræver [Maps pluginnet](obsidian://show-plugin?id=maps) installeret.
...
Du kan konfigurere landkort viewindstillingerne i [[Visninger#View indstillinger|View indstillingerne]].
...
Gå til [[Visninger#View indstillinger|View indstillingerne]] for at vise markører på landkortet og vælg en **Markør koordinat** egenskab. Denne egenskab indeholder breddegrad og højdegrad. De følgende formater accepteres:
