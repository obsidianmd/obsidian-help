...
aliases:
  - mobil
  - Brug af mobil appen
  - Kom i gang/Brug af mobil appen
cssclasses:
  - list-cards
publish: true
mobile: true
...
Mobil værektøjslinjen er en tilpasningsbar værktøjslinje, når du redigerer noter.

Når du redigerer en note vil du lægge mærke til en række ikoner i bunden af appen. Som standard viser den de funktioner, som giver hurtig tilgang til ofte brugte funktioner. Du kan også tilpasse dem.

> [!tip]  Rul værktøjslinjen
> hvis du har mange funktioner på værktøjslinjen, kan du stryge til højre og venstre på væktøjslinjen for at se flere funktioner.
...
På mobil appen kan du definere en funktion, som startes, når du stryger nedad på appen på samme måde, som når du opfrisker en side i andre apps.

Hurtig funktion åbner som standard [[Kommandopaletten]].
...
Ikonet med et plus i en cirkel lader dig oprette nye noter eller skifte til en eksisterende note. Det er ligesom at åbne [[Hurtigskifter|hurtigskifteren]].
