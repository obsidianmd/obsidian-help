...
Den global [[Funktioner|funktion]] `today()` kan anvendes til at få den nuværende dato, og `now()` kan anvendes til at få den nuværende dato med tidsangivelse.
...
Se [[Funktioner|listen af funktioner]], som kan anvendes i formler og [[Visninger|filtre]].
...
[[Link noter|Wikilinks]] i [[Egenskaber|egenskabssektionen]] af en note opfattes automatisk som linkobjekter. Links vil gengives som et klikbart link i [[Visninger|viewet]].
