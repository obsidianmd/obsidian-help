...
aliases:
  - Bookmarks
---
Bookmarks este un [[Module de bază|modul integrat]] care îți permite să accesezi rapid elementele pe care le folosești des. Un marcaj este o „scurtătură” care te duce imediat la elementul marcat.
...
>
> Sau, deschide fila Marcaje rulând **Bookmarks: Show bookmarks** din [[Paleta de comenzi|Paleta de comenzi]].
...
>
> - Dă clic dreapta pe un fișier în [[Exploratorul de fișiere|Explorator de fișiere]] și dă clic pe **Bookmark**.
>
> **Paleta de comenzi**:
>
> 1. Apasă `Ctrl+P` (sau `Cmd+P` pe macOS) pentru a deschide [[Paleta de comenzi|Paleta de comenzi]].
...
> **Explorator de fișiere**:
>
> - Dă clic dreapta pe un director în [[Exploratorul de fișiere|Explorator de fișiere]] și dă clic pe **Bookmark**.

> [!todo]- Marchează un termen de căutare
>
> **Caută**:
>
> 1. Introdu un [[Caută#Search terms|termen de căutare]].
...
>
> 1. Activează [[Vizualizator web|Vizualizatorul web]] în [[Module de bază|Module integrate]].
> 2. Deschide [[Vizualizator web|Vizualizatorul web]] și navighează la legătura pe care vrei să o marchezi.
> 3. În bara de adresă, selectează pictograma cu trei puncte de lângă pictograma de citire.
> 4. Selectează **Bookmark**.
>
> **Paleta de comenzi**:
>
> 1. Apasă `Ctrl+P` (sau `Cmd+P` pe macOS) în panoul [[Vizualizator web|Vizualizator web]] pentru a deschide [[Paleta de comenzi|Paleta de comenzi]].
