...
- **[[Module de bază]]** — Module încorporate, incluse implicit în Obsidian.
- **[[Module comunitare]]** — Module terțe instalate din comunitate.
...
Actualizare automată la cele mai recente [[Versiuni cu acces timpuriu]]. Aceste versiuni includ funcționalități noi, dar pot fi mai puțin stabile.

> [!info]+ Necesită licență Catalyst
> Această opțiune este disponibilă doar pentru utilizatorii cu o [[Licența Catalyst]].

### Limbă

Selectați limba preferată pentru interfața Obsidian. Selectați **[[Traduceri|Aflați cum să adăugați o limbă nouă în Obsidian]]** pentru a contribui cu o traducere.

### Ajutor

Selectați **[[Acasă|Deschide]]** pentru a accesa resurse de ajutor, inclusiv documentație, forumuri ale comunității și ghiduri de depanare.
...
Modul implicit în care se deschide o filă Markdown nou creată. Alegeți între [[Moduri de vizualizare și editare#Modul de citire|Modul de citire]] sau [[Moduri de vizualizare și editare#Modul de editare|Modul de editare]].

### Modul de editare implicit

Modul de editare implicit cu care va porni o filă nouă. Alegeți între [[Moduri de vizualizare și editare#Modul de previzualizare în direct|Modul de previzualizare în direct]] sau [[Moduri de vizualizare și editare#Modul sursă|Modul sursă]].

### Afișați modul de editare în bara de stare

Afișați comutatorul modului de editare în [[Bara de status|bara de stare]].
...
Specificațiile Markdown ignoră [[Sintaxă de bază pentru formatare#Întreruperi de linie|întreruperile de linie]] simple în modul de citire. Dezactivați această opțiune pentru a face vizibile întreruperile de linie simple.

#### Proprietăți în document

Alegeți modul în care sunt afișate [[Proprietăți|proprietățile]] în partea de sus a notelor. Selectați **sursă** pentru a afișa proprietățile ca YAML brut.

#### Plierea titlurilor

[[Pliere|Pliați]] tot conținutul aflat sub un titlu selectând pictograma de restrângere de lângă acesta.

### Permiteți plierea indentărilor

[[Pliere|Pliați]] o parte a unei indentări, precum listele, selectând pictograma de restrângere.
...
Această setare nu se aplică atunci când o [[Legături interne|legătură internă]] include o cale de director. De exemplu, crearea `[[Projects/Three laws of motion]]` creează nota în directorul `Projects`, relativ la rădăcina seifului.

### Locația implicită pentru atașamentele noi

Unde sunt plasate [[Atașamente|atașamentele]] nou adăugate. Opțiunile includ:
...
Ce legături se inserează la generarea automată a [[Legături interne|legăturilor interne]]. Opțiunile includ:
...
Folosiți un [[Directorul de configurare|director de configurare]] diferit de cel implicit. Trebuie să înceapă cu un punct.
...
Reconstruiește [[Cum stochează Obsidian datele#Cache-ul de metadate|cache-ul de metadate]] al seifului. Reconstruirea cache-ului poate dura de la câteva secunde până la câteva minute, în funcție de dimensiunea seifului dvs. Selectați **Reconstruiți** pentru a începe procesul.
...
Gestionați [[Teme|temele]] instalate și răsfoiți temele comunitare. Selectați **Gestionați** pentru a vizualiza și instala teme. Meniul derulant afișează tema activă curentă. Pictograma de director ![[lucide-folder-open.svg#icon]] deschide directorul temelor din [[Directorul de configurare|directorul de configurare]] al dvs.
...
Afișează bara de instrumente verticală de pe partea laterală a ferestrei. Aflați mai multe despre [[Panglică|panglică]].
...
> Pe mobil, personalizarea panglicii funcționează diferit. Consultați [[Panglică#Mobil|Personalizarea panglicii pe mobil]] pentru detalii.
...
Setați o pictogramă personalizată pentru aplicație. Selectați **Alegeți** pentru a selecta un fișier de pictogramă (`.icns`, `.ico`, `.png` sau `.svg`). Aflați mai multe despre [[Personalizare#Pictogramă personalizată a aplicației|pictogramele personalizate ale aplicației]].
...
> [!info]+ Doar pe macOS
> Această funcționalitate este concepută în principal pentru macOS. Aflați mai multe despre [[Personalizare#Translucență|translucență]].
...
Gestionați și vizualizați [[Fragmente CSS|fragmentele CSS]] stocate în seiful dvs. Fragmentele CSS sunt stocate în `/vault/.obsidian/snippets/`. Selectați pictograma de reîmprospătare pentru a reîncărca fragmentele, sau pictograma de director ![[lucide-folder-open.svg#icon]] pentru a deschide directorul fragmentelor.

## Combinații de taste

Pagina [[Combinații de taste]] vă permite să vizualizați, să setați și să personalizați [[Comenzi rapide de editare|combinațiile de taste]] pentru comenzile din Obsidian.
...
[[Module de bază]] sunt module încorporate, incluse implicit în Obsidian. Fiecare modul adaugă o funcționalitate specifică aplicației.

Pentru a activa sau dezactiva un modul de bază, selectați comutatorul de lângă numele modulului. Selectați pictograma plus ![[lucide-plus-circle.svg#icon]] pentru a vizualiza [[Combinații de taste]] pentru modul. Selectați pictograma de setări ![[lucide-settings.svg#icon]] pentru a deschide pagina de setări a modulului.

Folosiți bara de căutare pentru a filtra modulele după nume.

## Module comunitare

[[Module comunitare]] sunt module terțe create de comunitatea Obsidian. Răsfoiți și instalați module selectând **Răsfoiți**.

### Modul restricționat

[[Securitatea modulelor#Modul restricționat|Modul restricționat]] dezactivează toate modulele comunitare, din motive de securitate. Selectați **Activați și reîncărcați** pentru a activa modul restricționat.
