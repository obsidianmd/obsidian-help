...
Această pagină explică cum să-ți administrezi conținutul publicat. Pentru a afla cum să personalizezi stilul site-ului tău, vezi [[Personalizează-ți site-ul|Personalizează-ți site-ul]].
...
- Modulul integrat **Publish** este [[Configurează Obsidian Publish#Enable Obsidian Publish|activat]].
- Un [[Gestionează site-urile#Create a new site|site Publish]] este creat.
...
Setează `publish: true` în [[Proprietăți|Proprietățile]] unei note pentru a o include automat pentru publicare, fie ca notă nouă, fie ca notă schimbată.

Poți selecta automat și note și imagini conectate din directoare specifice, adăugându-le ca directoare **Incluse**:

1. În **Panglică**, selectează **Publică schimbările** ![[lucide-send.svg#icon]] sau deschide [[Paleta de comenzi|Paleta de comenzi]] și scrie **Publish: Publish changes...**.
...
Pentru a ignora o notă în Obsidian Publish, setează `publish: false` în [[Proprietăți|Proprietățile]] notei. Nota nu va mai apărea în lista notelor de publicat.
