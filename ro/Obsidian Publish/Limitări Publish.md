...
Obsidian Publish are suport minim pentru [[Module comunitare|module comunitare]]. 
...
Reține că afișajul grafic publicat nu suportă opțiunile complete de sortare și vizualizare disponibile în [[Afișaj grafic|afișajul grafic]] al aplicației.

## Fișiere media

Obsidian Publish nu este optimizat pentru streaming de video sau fișiere audio de mari dimensiuni. Includem câteva bune practici pentru gestionarea [[Fișiere media|fișierelor media]] în aceste documente. 
...
În plus, Publish nu suportă în prezent funcția aplicației de [[Caută#Embed search results in a note|rezultate de căutare încorporate]].
