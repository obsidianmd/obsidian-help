...
> Dacă doriți să deschideți un seif la distanță folosind Obsidian Sync, consultați [[Configurează Obsidian Sync]].
...
9. Verificați dacă conținutul seifului este neschimbat. Dacă este necesar, reactivați modulele comunitare navigând la **[[Setări]] → Module comunitare → Dezactivează modul restricționat**.
...
> Implicit, majoritatea sistemelor de operare ascund directoarele care încep cu un punct (`.`). Pentru mai multe informații despre directorul `.obsidian` și cum să-l accesați, consultați [[Cum stochează Obsidian datele#Setările seifului|setările seifului]] și [[Directorul de configurare|directoarele de configurare]].
