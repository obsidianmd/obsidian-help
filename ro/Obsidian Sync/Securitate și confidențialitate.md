...
Pentru siguranța ta, [[Introducere în Obsidian Sync|Obsidian Sync]] criptează [[Seifuri locale și la distanță|seiful tău la distanță]] și toate comunicările cu serverele Obsidian.
...
Criptarea standard este fundamental mai puțin sigură decât criptarea integrală, dar poate fi o opțiune convenabilă dacă nu te aștepți ca datele pe care le sincronizezi să fie complet private. De exemplu, dacă seiful tău sincronizat este [[Introducere în Obsidian Publish|publicat]] pe un site web public, precum acest site de asistență, atunci criptarea integrală nu este necesară.
...
2. Deconectează seiful la distanță pe fiecare dintre dispozitivele tale. Acest lucru se poate face accesând **[[Setări]] → Sync → Alege seiful la distanță → Deconectează**.
3. [[Configurează Obsidian Sync#Creează un nou seif la distanță|Creează un nou seif la distanță]] pe dispozitivul tău principal din aceeași pagină de setări. Opțional, poți șterge seiful la distanță anterior, deoarece oricum nu ai parola pentru el. (Este posibil să fie nevoie să ștergi seiful la distanță anterior dacă ai atins [[Întrebări frecvente#Câte seifuri la distanță pot avea?|limita de seifuri]])
...
1. Accesează **[[Setări]]** → **Sync** → **Copiază informațiile de depanare**.
