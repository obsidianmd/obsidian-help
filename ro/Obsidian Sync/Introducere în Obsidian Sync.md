...
- [[Configurează Obsidian Sync]]
	- Configurează Sync pe toate dispozitivele tale.
- [[Trece la Obsidian Sync|Trecerea la Obsidian Sync]]
	- Pregătește-ți seiful Obsidian pentru a folosi Sync.
- [[Setări Sync și sincronizare selectivă|Sincronizare selectivă]]
	- Configurează ce fișiere și setări să fie sincronizate.
- [[Planuri și limite de stocare]]
	- Află mai multe despre planurile de abonament Sync.
- [[Planuri și limite de stocare|Stocare seif la distanță]]
...
- [[Fă copii de rezervă ale fișierelor Obsidian]]
...
- [[Depanează Obsidian Sync]]
	- Probleme comune de sincronizare și soluții.

## Important

Dacă folosești Obsidian Sync împreună cu alți furnizori de stocare în cloud, precum Dropbox, Google Drive sau OneDrive, te rugăm să [[Fă copii de rezervă ale fișierelor Obsidian|faci o copie de rezervă a fișierelor tale Obsidian]] pentru a preveni conflictele de sincronizare. Recomandăm cu tărie [[Trece la Obsidian Sync|trecerea completă la Obsidian Sync]].

Vezi [[Întrebări frecvente]] pentru întrebări frecvente și mai multe detalii despre Obsidian Sync.
