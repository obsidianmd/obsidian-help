...
Trebuie să ai un [[Planuri și limite de stocare|abonament Obsidian Sync]] activ.
...
| `--region` | [[Regiuni Sync\|Regiunea]] serverului (automată dacă este omisă) |
...
| `--password` | Parola de criptare integrală (solicitată dacă este omisă) |
| `--device-name` | Numele dispozitivului afișat în [[Istoricul versiunilor\|istoricul versiunilor de sincronizare]] |
| `--config-dir` | Numele [[Directorul de configurare\|directorului de configurare]] (implicit: `.obsidian`) |
...
Vizualizează sau modifică [[Setări Sync și sincronizare selectivă|setările de sincronizare]] pentru un seif. Rulează fără opțiuni pentru a afișa configurația curentă.
