...
Proprietățile au propria [[Caută|sintaxă de căutare]] pe care o puteți folosi împreună cu alți termeni și operatori de căutare. [[Caută#Search properties|Consultați sintaxa de căutare pentru proprietăți]].

### Șabloane

Puteți adăuga proprietăți la [[Plugins/Șabloane|Șabloane]].
...
Puteți redenumi o proprietate făcând clic dreapta pe ea în [[Mod de vizualizare a proprietăților|modul de vizualizare a tuturor proprietăților]].

### Moduri de afișare

Puteți schimba modul în care sunt afișate proprietățile în nota dvs. accesând **[[Setări]] → Editor → Properties in document**. Opțiunile sunt:

- **Visible** (implicit) – afișează proprietățile în partea de sus a notei, dacă există.
- **Hidden** – ascunde proprietățile, care pot fi afișate în continuare în bara laterală prin [[Mod de vizualizare a proprietăților]].
- **Source** – afișează proprietățile în format YAML text simplu.

### Fragmente CSS

Puteți folosi [[Fragmente CSS|fragmente CSS]] pentru a schimba aspectul unor note specifice.

### Neacceptate

Câteva funcții nu sunt momentan acceptate în Obsidian:

- **Proprietăți imbricate**: Pentru a vizualiza proprietăți imbricate, vă recomandăm să folosiți [[Moduri de vizualizare și editare#Source mode|modul sursă]].
- **Editarea în masă a proprietăților**: Pentru editare în masă aprofundată în afara [[Mod de vizualizare a proprietăților]], vă recomandăm să folosiți instrumente de editare în masă precum VSCode, scripturi și module ale comunității.
...
Valorile din listă pot conține text, numere și [[Legături interne|legături interne]]. Când folosiți [[Legături interne|legături interne]] în proprietăți de tip listă, încadrați-le cu ghilimele.
...
> [!info]- Windows
> **[[Setări]] → Time & Language → Language & Region → Regional Format → Change Formats**
> 
...
Cu modulul [[Note zilnice|Note zilnice]] activat, proprietatea de dată va funcționa suplimentar ca o legătură internă către nota zilnică corespunzătoare acelei date.

![[Note zilnice#^daily-notes-date]]
...
Proprietatea `tags` este una dintre [[#Default properties|proprietățile implicite]] ale Obsidian. Consultați [[Etichete|Etichete]] pentru mai multe informații despre folosirea etichetelor în Obsidian.
...
| ------------ | ---- | ------------------------------------------------------------ |
| `tags`       | Listă | Consultați [[Editare și formatare/Etichete\|Etichete]].                   |
| `aliases`    | Listă | Consultați [[Pseudonime]].                                             |
| `cssclasses` | Listă | Vă permite să stilizați note individuale folosind [[Fragmente CSS|fragmente CSS]]. |

### Proprietăți pentru Obsidian Publish

Următoarele proprietăți implicite pot fi folosite cu [[Introducere în Obsidian Publish|Obsidian Publish]]:

| Proprietate      | Descriere                                                                                                |
| ------------- | ---------------------------------------------------------------------------------------------------------- |
| `publish`     | Consultați [[Publică-ți conținutul#Automatically select data to publish\|Selectați automat datele de publicat]]. |
| `permalink`   | Consultați [[Permalinkuri]].                                                                            |
| `description` | Consultați [[Previzualizări pentru rețele sociale#Description\|Descriere]].                                               |
| `image`       | Consultați [[Previzualizări pentru rețele sociale#Image\|Imagine]].                                                           |
| `cover`       | Consultați [[Previzualizări pentru rețele sociale#Image\|Imagine]].                                                           |
...
> [!tip] Dacă trebuie să convertiți fișierele din seiful dvs. la formatul [[#Default properties|proprietăților implicite]], puteți folosi [[Convertor de format]] pentru a vă schimba seiful în masă.
