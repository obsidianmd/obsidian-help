...
Plierea este activată implicit. Pentru a dezactiva plierea, deschideți **[[Setări]]** → **Editor**, apoi dezactivați **Permiteți plierea indentărilor** sau **Permiteți plierea titlurilor**, în funcție de nevoile dvs.

Pentru a comuta toate secțiunile în același timp, folosiți următoarele comenzi:

- Pentru a plia toate secțiunile, deschideți [[Paleta de comenzi|Paleta de comenzi]], apoi selectați **Pliați toate titlurile și listele**.
- Pentru a extinde toate secțiunile, deschideți [[Paleta de comenzi|Paleta de comenzi]], apoi selectați **Extindeți toate titlurile și listele**.

> [!tip] Sfat
> Dacă preferați să pliați folosind tastatura, puteți atribui [[Combinații de taste|combinații de taste]] comenzilor **Pliați mai puțin** și **Pliați mai mult**.
>
