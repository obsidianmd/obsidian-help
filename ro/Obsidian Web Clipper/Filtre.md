...
Aplică [[Sintaxă de bază pentru formatare]] și [[Sintaxă avansată de formatare]] textului.
...
Convertește șiruri, array-uri sau obiecte în sintaxă Markdown pentru legături (a nu se confunda cu [[Filtre#`wikilink`|wikilink]]).
...
Convertește un array sau un array de obiecte într-un [[Sintaxă avansată de formatare#Tables|tabel Markdown]]:
...
Convertește șiruri, array-uri sau obiecte în sintaxă Obsidian [[Leagă notițe|wikilink]].
...
Convertește un șir într-un șir formatat [[Markdown specific Obsidian]].
