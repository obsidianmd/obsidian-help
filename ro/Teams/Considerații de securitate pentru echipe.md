...
Nu avem un magazin comunitar pentru [[Fragmente CSS|fragmentele CSS]]. Aceste fișiere sunt de obicei obținute din cadrul [comunității noastre Obsidian](https://obsidian.md/community) sau din depozite GitHub publice.
...
Obsidian nu susține SSO. În majoritatea cazurilor de utilizare, Obsidian nu necesită un cont sau o autentificare la locul dumneavoastră de muncă, cu excepția cazului în care folosiți [[Introducere în Obsidian Publish|Obsidian Publish]] sau [[Introducere în Obsidian Sync|Obsidian Sync]].

**Obsidian susține autentificarea cu mai mulți factori (MFA)?**
Obsidian susține [[Autentificare în doi factori|autentificarea în doi pași]] (2FA) pentru conturile Obsidian, dar nu susține 2FA pentru deschiderea și utilizarea aplicației de bază. Utilizatorii [[Introducere în Obsidian Sync|Obsidian Sync]] și [[Introducere în Obsidian Publish|Obsidian Publish]] care au 2FA activat vor trebui să confirme cheia lor 2FA la prima autentificare în aplicație.
...
Totuși, puteți renunța la această sumă cotată prin comandă de achiziție acceptând să plătiți un avans. Vă rugăm să [[Ajutor și suport#Contact Obsidian support|contactați asistența Obsidian]] pentru a afla mai multe despre această opțiune.
