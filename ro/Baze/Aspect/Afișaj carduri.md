...
aliases:
  - Cards view
---
Cards este un tip de [[Afișaje|vizualizare]] pe care îl poți folosi în [[Introducere în Baze|Baze]].
...
Setările vizualizării de tip carduri pot fi configurate în [[Afișaje#View settings|Setările vizualizării]].
...
Cardurile acceptă o imagine de copertă opțională, care este o [[Proprietăți|proprietate]] afișată ca imagine în partea de sus a cardului. Proprietatea poate fi oricare dintre următoarele:

- O legătură către un [[Atașamente|atașament]] local `"[[link/to/attachment.jpg]]"`
