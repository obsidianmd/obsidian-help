...
aliases:
  - Map view
---
Map este un tip de [[Afișaje|vizualizare]] pe care îl poți folosi în [[Introducere în Baze|Baze]]. Necesită instalarea modulului [Maps](obsidian://show-plugin?id=maps).
...
Vizualizările de tip hartă necesită Obsidian 1.10. Modulul [Maps](obsidian://show-plugin?id=maps) este un [[Module comunitare|modul comunitar]] oficial pe care îl poți descărca separat.

1. Urmează instrucțiunile din [[Module comunitare#Install a community plugin]]
...
Setările vizualizării de tip hartă pot fi configurate în [[Afișaje#View settings|Setările vizualizării]].
...
Pentru a afișa pini pe hartă, mergi la [[Afișaje#View settings|setările vizualizării]] și selectează o proprietate pentru **coordonatele marcajului**. Proprietatea trebuie să conțină coordonate de latitudine și longitudine. Sunt acceptate următoarele formate:
...
Dacă stochezi coordonatele ca proprietăți separate `latitude` și `longitude`, le poți combina cu o proprietate de tip [[Sintaxă Baze#Formulas|formulă]], definind-o ca un array de coordonate folosind următoarea formulă: `[latitude, longitude]`.
...
Poți face legătura către servicii populare de hărți folosind [[Formule|Formule]]. De exemplu, pinul tău poate afișa o legătură către Google Maps folosind următoarea formulă:
...
Dacă harta apare goală când încarci pentru prima dată modulul Maps, încearcă să [[Actualizează Obsidian|actualizezi versiunea de instalare a Obsidian]].
