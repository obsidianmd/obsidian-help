...
Vizualizările pot fi afișate cu aspecte diferite, inclusiv ca ![[lucide-table.svg#icon]] **tabel**, ![[lucide-list.svg#icon]] **listă**, ![[lucide-layout-grid.svg#icon]] **carduri** și ![[lucide-map.svg#icon]] **hartă**. Aspecte suplimentare pot fi adăugate prin [[Module comunitare|module comunitare]]. Unele aspecte sunt încă în dezvoltare și necesită [[early access versions|versiuni cu acces timpuriu]] ale Obsidian.

| Aspect                | Descriere                                                                                   | Versiune&nbsp;aplicație |
| --------------------- | --------------------------------------------------------------------------------------------- | ---------------- |
| [[Afișaj tabel\|Tabel]] | Afișează fișierele ca rânduri într-un tabel. Coloanele sunt populate din [[properties|proprietăți]] din notele tale.    | 1.9              |
...
1. **Proprietate** — îți permite să alegi o [[Proprietăți|proprietate]] din seiful tău, inclusiv [[Sintaxă Baze#File properties|proprietăți ale fișierului]].
...
3. **Valoare** — îți permite să alegi valoarea cu care compari. Valorile pot include calcule matematice și [[Funcții|funcții]].
...
Dă clic pe butonul de cod ![[lucide-code-xml.svg#icon]] pentru a folosi editorul **filtru avansat**. Acesta afișează sintaxa brută [[Sintaxă Baze|sintaxa]] a filtrului și poate fi folosit împreună cu [[Funcții|funcții]] mai complexe care nu pot fi afișate folosind interfața de tip point-and-click.
...
Poți încorpora fișiere bază în [[Încorporează fișiere|orice alt fișier]] folosind sintaxa `![[File.base]]`. Va fi folosită prima vizualizare din listă. Poți schimba ordinea trăgând vizualizările din meniul de vizualizare.
