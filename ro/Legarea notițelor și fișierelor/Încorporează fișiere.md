...
Poți încorpora și anumite [[Legături interne#Creează o legătură către un titlu dintr-o însemnare|titluri]] și [[Legături interne#Creează o legătură către un bloc dintr-o însemnare|blocuri]].

```md
![[Legături interne#^b15695]]
```
...
Pentru a încorpora o listă dintr-o altă însemnare, adaugă mai întâi un [[Legături interne#Creează o legătură către un bloc dintr-o însemnare|identificator de bloc]] la lista ta:
...
![[Caută#Embed search results in a note]]
