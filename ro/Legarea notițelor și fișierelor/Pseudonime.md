...
Dacă vrei doar să schimbi modul în care apare o legătură într-un singur loc, vezi cum să [[Legături interne#Modifică textul afișat al legăturii|Modifici textul afișat al legăturii]] în schimb.

![[Legături interne#^callout-internal-links-link-text]]

## Adaugă un alias la o însemnare

Pentru a adăuga un alias pentru o însemnare, adaugă proprietatea `aliases` în [[Proprietăți|Proprietățile]] însemnării. Alias-urile trebuie formatate întotdeauna ca o listă în YAML.
...
1. Începe să scrii alias-ul într-o [[Legături interne|legătură internă]]. Orice alias apare în lista de sugestii, cu o pictogramă de săgeată curbată lângă el.
...
Folosind [[Referințe|Referințele]], poți găsi mențiuni nelegate ale alias-urilor.

De exemplu, după ce ai setat „AI” ca alias pentru „Artificial intelligence”, poți vedea mențiunile „AI” din alte însemnări.

Dacă legi o mențiune nelegată la un alias, Obsidian transformă mențiunea într-o [[Legături interne|legătură internă]] cu alias-ul ca text afișat.
