...
- Dacă descoperiți o vulnerabilitate de securitate într-un modul al comunității, consultați fișierul `security.md` sau `readme.md` al autorului modulului pentru modul de raportare. Pentru defecte critice, raportați problema și către [[Help and support#Contactează asistența Obsidian|asistența Obsidian]].
- Dacă suspectați că un modul al comunității este malițios, îl puteți semnala direct din pagina sa din director, îl puteți raporta către [[Help and support#Contactează asistența Obsidian|asistența Obsidian]], sau puteți trimite un mesaj privat moderatorilor noștri.
