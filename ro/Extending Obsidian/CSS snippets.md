...
> [!tip] Dacă aveți nevoie de îndrumări privind gestionarea CSS pentru [[Introduction to Obsidian Publish|Obsidian Publish]], asigurați-vă că parcurgeți [[Customize your site]].
...
Obsidian caută fragmente CSS în [[Configuration folder|directorul de configurare]] al seifului.

## Adăugarea unui fragment

Pentru a adăuga un fragment CSS pe **Desktop** ![[lucide-monitor-check.svg#icon]], urmați acești pași:

1. Deschideți **[[Settings]]** ![[lucide-settings.svg#icon]].
...
2. Deschideți [[Configuration folder]] și creați un director numit `snippets` dacă acesta nu există.
3. Adăugați fragmentul CSS în acest director.
4. Deschideți **[[Settings]]** ![[lucide-settings.svg#icon]] din Obsidian.
...
Alternativ, puteți
- [[Sync your notes across devices|Sync]] orice modificare cu serviciul dumneavoastră de sincronizare.
...
> [!tip] Nu este necesar să reporniți Obsidian pentru ca modificările să aibă efect. Cu toate acestea, este posibil să fie nevoie să folosiți comanda [[Command palette]] pentru a reîncărca Obsidian fără salvare, pentru a vedea modificările în tema sau nota curentă.

## Scrierea CSS pentru Obsidian

Obsidian oferă mai multe metode care fac scrierea CSS mai simplă și mai puternică.

Are o gamă largă de [variabile CSS](https://docs.obsidian.md/Reference/CSS+variables/CSS+variables) pentru a modifica cu ușurință părți din Obsidian și un [[Properties#Property types|tip de proprietate]] încorporat pentru a schimba aspectul uneia sau mai multor note.

> [!example] Variabile
> Creați un fișier numit `headers.css` cu următorul conținut pentru a schimba culorile celor șase [[Basic formatting syntax#Headings|niveluri de titlu]] într-un curcubeu:
>
> ```css
> body {
>   --h1-color: red;
...
> [!example] Clase CSS
> Atribuiți numele unei clase CSS personalizate (sau o listă de clase CSS) unei [[Properties|proprietăți]] predefinite `cssclasses` pentru a face ca una sau mai multe note să arate diferit față de celelalte.
> 
> **CSS**:
> ```css
> .red-border img {
